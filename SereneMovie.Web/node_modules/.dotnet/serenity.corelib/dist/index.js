...
function blockUI(options) {
  function block() {
    ...
    div.setAttribute("style", `z-index: ${(_a2 = options == null ? void 0 : options.zIndex) != null ? _a2 : 2e3}; border: none; margin: 0px; padding: 0px; width: 100%; height: 100%; top: 0px; left: 0px; opacity: 0; cursor: wait; position: fixed;`);
...
function blockUndo() {
  ...
  if (blockUICount < 1)
    return;
  if (--blockUICount === 0 && typeof document !== "undefined")
    (_a2 = document.body.querySelector(":scope > .blockUI.blockOverlay")) == null ? void 0 : _a2.remove();
}
...
function isBS3() {
  var _a2, _b, _c, _d;
  return (((_d = (_c = (_b = (_a2 = getjQuery()) == null ? void 0 : _a2.fn) == null ? void 0 : _b.modal) == null ? void 0 : _c.Constructor) == null ? void 0 : _d.VERSION) + "").charAt(0) == "3";
}
function isBS5Plus() {
...
function triggerRemoveAndClearAll(element) {
...
Fluent.prototype.attr = function(name, value) {
  ...
  if (value === void 0 && arguments.length < 2)
    return (_a2 = this.el) == null ? void 0 : _a2.getAttribute(name);
  if (this.el) {
...
Fluent.prototype.children = function(selector) {
  var _a2, _b;
  if (selector == null)
    return Array.from(((_a2 = this.el) == null ? void 0 : _a2.children) || []);
...
Fluent.prototype.closest = function(selector) {
  var _a2;
  return new Fluent((_a2 = this.el) == null ? void 0 : _a2.closest(selector));
};
...
Fluent.prototype.hasClass = function(klass) {
  var _a2;
  return !!((_a2 = this.el) == null ? void 0 : _a2.classList.contains(klass));
};
...
Fluent.prototype.removeAttr = function(name) {
  var _a2;
  (_a2 = this.el) == null ? void 0 : _a2.removeAttribute(name);
  return this;
};
...
Fluent.prototype.findFirst = function(selector) {
  var _a2;
  return new Fluent((_a2 = this.el) == null ? void 0 : _a2.querySelector(selector));
};
...
Fluent.prototype.findEach = function(selector, callback) {
  if (!this.el || !callback)
    return this;
  this.el.querySelectorAll(selector).forEach((x) => callback(Fluent(x)));
  return this;
};
...
Fluent.prototype.nextSibling = function(selector) {
  var _a2;
  var sibling = (_a2 = this.el) == null ? void 0 : _a2.nextElementSibling;
...
Fluent.prototype.parent = function() {
  var _a2;
  return new Fluent((_a2 = this.el) == null ? void 0 : _a2.parentNode);
};
...
Fluent.prototype.prevSibling = function(selector) {
  var _a2;
  var sibling = (_a2 = this.el) == null ? void 0 : _a2.previousElementSibling;
  while (sibling && selector != null && !sibling.matches(selector))
...
Fluent.prototype.text = function(value) {
  var _a2;
  if (value === void 0 && !arguments.length)
    return (_a2 = this.el) == null ? void 0 : _a2.textContent;
  if (!this.el)
    return this;
...
function autoRegisterViaTypeInfo(type) {
  ...
  if (((_a2 = typeInfo.interfaces) == null ? void 0 : _a2.length) && !Object.prototype.hasOwnProperty.call(implementedInterfacesSymbol)) {
...
function getTypeNameProp(type) {
  var _a2;
  return ((_a2 = peekTypeInfo(type)) == null ? void 0 : _a2.typeName) || void 0;
}
...
((Enum2) => {
  Enum2.toString = (enumType, value) => {
    ...
    if (typeof value !== "number")
      return "" + value;
    var values = enumType;
    if (value === 0 || !((_a2 = peekTypeInfo(enumType)) == null ? void 0 : _a2.enumFlags)) {
      for (var i in values) {
        if (values[i] === value) {
          return i;
        }
...
function registerEditor(type, name, intf) {
  ...
  if (!((_a2 = peekTypeInfo(type).customAttributes) == null ? void 0 : _a2.some((x) => getInstanceType(x) === x)))
...
function getCustomAttribute(type, attrType, inherit = true) {
  ...
  if (!type || attrType == null)
    return null;
  do {
    let attrs = (_a2 = peekTypeInfo(type)) == null ? void 0 : _a2.customAttributes;
    if (attrs) {
...
function localText(key, defaultText) {
  var _a2, _b, _c;
  return (_c = (_b = (_a2 = getTable()[key]) != null ? _a2 : defaultText) != null ? _b : key) != null ? _c : "";
}
...
var _Dialog = class _Dialog {
  constructor(opt, create = true) {
    ...
    this.dialogResult = (_a2 = this.el) == null ? void 0 : _a2.dataset.dialogResult;
    if (!create) {
      return;
    }
  ...
  close(result) {
    ...
    if (target.classList.contains("panel-body"))
      ...
      (_c = (_a2 = getjQuery()) == null ? void 0 : (_b = _a2(this.el)).dialog) == null ? void 0 : _c.call(_b, "close");
  ...
  open() {
    ...
    if (target.classList.contains("panel-body"))
      ...
      (_a2 = getjQuery()) == null ? void 0 : _a2(target).dialog("open");
    else if (target.classList.contains("modal")) {
      if (isBS5Plus()) {
  ...
  title(value) {
    var _a2;
    let title = (_a2 = this.getHeaderNode()) == null ? void 0 : _a2.querySelector(".modal-title, .panel-titlebar-text, .ui-dialog-title");
    if (value === void 0 && !arguments.length)
  ...
  getFooterNode() {
    var _a2;
    return (_a2 = this.getDialogNode()) == null ? void 0 : _a2.querySelector(".modal-footer, .panel-footer, .ui-dialog-footer");
  }
  /** Gets the header element of the dialog */
  getHeaderNode() {
    var _a2;
    return (_a2 = this.getDialogNode()) == null ? void 0 : _a2.querySelector(".modal-header, .panel-titlebar, .ui-dialog-titlebar");
  }
  onButtonClick(e, btn) {
  ...
  createBSModal(opt) {
    ...
    if (bs5 && bootstrap.Modal) {
      ...
      (_c = (_b = (_a2 = getjQuery()) == null ? void 0 : _a2(modal.getNode())) == null ? void 0 : _b.modal) == null ? void 0 : _c.call(_b, modalOpt);
    }
    ;
  }
  createPanel(opt) {
  ...
  createUIDialog(opt) {
    ...
    (_a2 = getjQuery()) == null ? void 0 : _a2(this.el).dialog(uiOpt);
  }
  /**
  ...
  dispose() {
    ...
    try {
      let target = (_a2 = getDialogEventsNode(this.el)) != null ? _a2 : this.el;
      if (!target)
        return;
      try {
...
function hasBSModal() {
  var _a2, _b;
  return isBS5Plus() || !!((_b = (_a2 = getjQuery()) == null ? void 0 : _a2.fn) == null ? void 0 : _b.modal);
}
function hasUIDialog() {
  var _a2, _b;
  return !!((_b = (_a2 = getjQuery()) == null ? void 0 : _a2.ui) == null ? void 0 : _b.dialog);
}
function uiAndBSButtonNoConflict() {
  var _a2, _b, _c;
  const $2 = getjQuery();
  if ($2 && ((_b = (_a2 = $2.fn) == null ? void 0 : _a2.button) == null ? void 0 : _b.noConflict) && ((_c = $2.ui) == null ? void 0 : _c.button)) {
...
function dialogButtonToBS(x) {
  ...
  Fluent.addClass(button, (_a2 = x.cssClass) != null ? _a2 : "btn-secondary");
  if (x.hint)
...
function closePanel(el) {
  ...
  if (!panel || panel.classList.contains("hidden"))
    return;
  var eventsNode = (_a2 = getDialogEventsNode(el)) != null ? _a2 : panel;
...
function openPanel(element, uniqueName) {
  ...
  if (!panel)
    return;
  let container = panel.parentElement && panel.parentElement !== document.body ? panel.parentElement : (_c = (_b = (_a2 = document.querySelector(".panels-container")) != null ? _a2 : document.querySelector("section.content")) != null ? _b : panel.parentElement) != null ? _c : document.body;
...
function getDialogEventsNode(element) {
  ...
  if (!element)
    return null;
  return (_b = element.closest(".modal, .panel-body, .ui-dialog-content")) != null ? _b : (_a2 = getDialogNode(element)) == null ? void 0 : _a2.querySelector(".panel-body, .ui-dialog-content");
}
function getDialogContentNode(element) {
  ...
  if (!element)
    return null;
  return (_b = element.closest(".modal-body, .panel-body, .ui-dialog-content")) != null ? _b : (_a2 = getDialogNode(element)) == null ? void 0 : _a2.querySelector(".modal-body, .panel-body, .ui-dialog-content");
}
...
function createMessageDialog(opt) {
  ...
  if (!hasBSModal() && !hasUIDialog()) {
    ...
    (_a2 = opt.options) == null ? void 0 : _a2.onClose(result);
    return {
      result
    };
  }
...
var modalShow = (e) => {
  var _a2;
  var body = (_a2 = Dialog.getInstance(e.target)) == null ? void 0 : _a2.getContentNode();
  if (body) {
...
(function() {
  ...
  if (typeof document !== "undefined" && ((_c = k = (_b = (_a2 = document.querySelector("script#ScriptCulture")) == null ? void 0 : _a2.textContent) == null ? void 0 : _b.trim()) == null ? void 0 : _c.length)) {
    var sc = JSON.parse(k);
...
function formatNumber(num, format2, decOrLoc, grp) {
  ...
  if (isNaN(num)) {
    return (_a2 = fmt2.nanSymbol) != null ? _a2 : Culture.nanSymbol;
  }
  if (format2 === "i") {
    return num.toString();
  }
...
function formatDate(d, format2, locale) {
  ...
  if (format2 == null || format2 == "d")
    format2 = (_a2 = locale.dateFormat) != null ? _a2 : Culture.dateFormat;
...
var Toastr = class {
  constructor(options) {
    ...
    var _a2;
    this.options = Object.assign(Object.assign({}, (_a2 = initialInstance == null ? void 0 : initialInstance.options) != null ? _a2 : initialOptions), options);
  }
  getContainer(options, create = false) {
    var _a2, _b, _c;
    let container = document.getElementById((_a2 = options == null ? void 0 : options.containerId) != null ? _a2 : this.options.containerId);
    if (container || !create)
      return container;
  ...
  removeContainerIfEmpty(options) {
    ...
    if (!container)
      return;
    if (!((_a2 = container.hasChildNodes) == null ? void 0 : _a2.call(container)) && container.parentNode)
  ...
  removeToast(toastElement, options) {
    ...
    if (toastElement !== document.activeElement) {
      (_a2 = toastElement.parentNode) == null ? void 0 : _a2.removeChild(toastElement);
      this.previousToast = null;
...
((ErrorHandling3) => {
  function showServiceError(error, errorInfo, errorMode) {
    ...
    if (error || !errorInfo) {
      showMessage((_b = (_a2 = error == null ? void 0 : error.Message) != null ? _a2 : error == null ? void 0 : error.Code) != null ? _b : localText("Services.GenericErrorMessage", "An error occurred while processing your request."));
      return;
    }
  ...
  function runtimeErrorHandler(message, filename, lineno, colno, error) {
    ...
    try {
      if (!ErrorHandling3.isDevelopmentMode())
        return;
      var errorInfo = (_a2 = error == null ? void 0 : error.stack) != null ? _a2 : error == null ? void 0 : error.toString();
  ...
  function isDevelopmentMode() {
    var _a2;
    var hostname = ((_a2 = window.location.hostname) != null ? _a2 : "").toLowerCase();
  ...
  function unhandledRejectionHandler(err) {
    ...
    try {
      ...
      if (reason2.origin == "serviceCall") {
        err.preventDefault();
        if (!reason2.silent && ((_a2 = reason2.kind) != null ? _a2 : "exception") === "exception") {
          console.error(err);
        }
      }
    } catch (e) {
...
function serviceOptions(url, options) {
  ...
  (_a2 = options.headers) != null ? _a2 : options.headers = {};
...
function requestStarting() {
  ...
  if ($2 && typeof $2.active === "number") {
    $2.active++ === 0 && ((_b = (_a2 = $2.event) == null ? void 0 : _a2.trigger) == null ? void 0 : _b.call(_a2, "ajaxStart"));
...
function requestFinished() {
  ...
  let $2 = getjQuery();
  if ($2 && typeof $2.active === "number") {
    !--$2.active && ((_b = (_a2 = $2.event) == null ? void 0 : _a2.trigger) == null ? void 0 : _b.call(_a2, "ajaxStop"));
    ...
    return __async(this, null, function* () {
      ...
      try {
        ...
        try {
          ...
          var fetchResponse = yield fetch(url, fetchInit);
          if (!fetchResponse.ok) {
...
function serviceCall(options) {
  var _a2;
  if ((_a2 = options == null ? void 0 : options.async) != null ? _a2 : true)
  ...
  return new Promise((resolve, reject) => {
    ...
    try {
      ...
      if (options.cache == "no-store")
        (_b = (_a3 = options.headers)["Cache-Control"]) != null ? _b : _a3["Cache-Control"] = "no-cache, no-store, max-age=0";
...
function handleError(response, errorInfo, options) {
  ...
  if (((_a2 = options == null ? void 0 : options.onError) == null ? void 0 : _a2.call(options, response, errorInfo)) || (options == null ? void 0 : options.errorMode) === "none")
    return;
...
function getScriptDataHash(name, reload) {
  ...
  if (!scriptDataHash && typeof document !== "undefined" && (json = ((_b = (_a2 = document.querySelector("script#RegisteredScripts")) == null ? void 0 : _a2.innerHTML) != null ? _b : "").trim()) && json.charAt(0) == "{") {
...
function fetchScriptData(name) {
  var _a2;
  let key = name + "?" + ((_a2 = getScriptDataHash(name)) != null ? _a2 : "");
  ...
  return fetchPromises[key] = function() {
    return __async(this, null, function* () {
      ...
      try {
        blockUI();
        try {
          let url = resolveUrl("~/DynamicData/") + name + "?v=" + ((_a3 = getScriptDataHash(name)) != null ? _a3 : (/* @__PURE__ */ new Date()).getTime());
          requestStarting();
          try {
...
function peekScriptData(name) {
  var _a2;
  return (_a2 = getGlobalObject()[scriptDataSymbol]) == null ? void 0 : _a2[name];
}
...
function setScriptData(name, value) {
  ...
  typeof document !== "undefined" && ((_a2 = document.dispatchEvent) == null ? void 0 : _a2.call(document, new Event("scriptdatachange." + name)));
}
...
var _Tooltip = class _Tooltip {
  constructor(el, opt, create = true) {
    ...
    if (create === true && this.el) {
      ...
      if (instance) {
        ...
        opt != null ? opt : opt = {};
        (_a2 = opt.trigger) != null ? _a2 : opt.trigger = "hover focus";
        let $2 = getjQuery();
  ...
  dispose() {
    ...
    if (!instance)
      return;
    (_a2 = instance[isBS3() ? "destroy" : "dispose"]) == null ? void 0 : _a2.call(instance);
  }
  ...
  static existingInstance(el) {
    ...
    let instance;
    if (typeof bootstrap !== "undefined")
      instance = (_b = (_a2 = bootstrap == null ? void 0 : bootstrap.Tooltip) == null ? void 0 : _a2.getInstance) == null ? void 0 : _b.call(_a2, el);
    if (instance)
      return instance;
  ...
  static get isAvailable() {
    var _a2, _b;
    return !!(typeof bootstrap !== "undefined" && bootstrap.Tooltip || ((_b = (_a2 = getjQuery()) == null ? void 0 : _a2.fn) == null ? void 0 : _b.tooltip));
  }
  setTitle(value) {
    var _a2, _b, _c, _d;
    if (!this.el)
    ...
    (_a2 = instance == null ? void 0 : instance[isBS3() ? "fixTitle" : "_fixTitle"]) == null ? void 0 : _a2.call(instance);
  ...
  toggle(show) {
    ...
    if (!instance)
      return this;
    (_a2 = instance == null ? void 0 : instance[show ? "show" : "hide"]) == null ? void 0 : _a2.call(instance);
    return this;
  }
  hide() {
...
var _Uploader = class _Uploader {
  ...
  endBatch() {
    return __async(this, null, function* () {
      var _a2, _b, _c, _d;
      if ((_b = (_a2 = this.batch) == null ? void 0 : _a2.filePaths) == null ? void 0 : _b.length) {
  ...
  isMultiple() {
    var _a2, _b, _c;
    return !!((_c = this.opt.multiple) != null ? _c : (_b = (_a2 = this.opt) == null ? void 0 : _a2.input) == null ? void 0 : _b.getAttribute("multiple"));
  }
  getTypePredicate() {
    var _a2, _b, _c;
    if (this.opt.ignoreType)
      return alwaysTrue;
    let acceptVal = (_c = this.opt.accept) != null ? _c : (_b = (_a2 = this.opt) == null ? void 0 : _a2.input) == null ? void 0 : _b.getAttribute("accept");
    if (!acceptVal)
      return alwaysTrue;
  ...
  watchInput(input) {
    input.addEventListener("change", (e) => __async(this, null, function* () {
      var _a2, _b;
      if ((_b = (_a2 = e.target) == null ? void 0 : _a2.files) == null ? void 0 : _b.length) {
        try {
  ...
  watchDropZone(node) {
    ...
    node.addEventListener("drop", (e) => {
      var _a2, _b;
      e.preventDefault();
      if ((_b = (_a2 = e.dataTransfer.items) == null ? void 0 : _a2[0]) == null ? void 0 : _b.webkitGetAsEntry()) {
    ...
    node.addEventListener("paste", (e) => {
      var _a2, _b;
      if ((_b = (_a2 = e.clipboardData.items) == null ? void 0 : _a2[0]) == null ? void 0 : _b.webkitGetAsEntry()) {
  ...
  entriesApi(e, items) {
    return __async(this, null, function* () {
      ...
      const skipRest = () => {
        var _a2, _b;
        return !multiple && ((_b = (_a2 = this.batch) == null ? void 0 : _a2.filePaths) == null ? void 0 : _b.length) > 0;
      };
  ...
  uploadBatch(batch, request) {
    return __async(this, null, function* () {
      ...
      (_b = (_a2 = this.opt).batchStart) == null ? void 0 : _b.call(_a2, { batch });
      try {
        yield new Promise((resolve, reject) => {
          ...
          try {
            ...
            const onerror = (data) => {
              ...
              try {
                try {
                  (_b3 = (_a4 = this.opt).errorHandler) == null ? void 0 : _b3.call(_a4, data);
                } finally {
                  reject(data);
                }
              } catch (exception) {
            ...
            xhr.onload = (event) => {
              ...
              try {
                if (xhr.status === 200) {
                  ...
                  (_b3 = (_a4 = this.opt).batchSuccess) == null ? void 0 : _b3.call(_a4, data);
                  resolve(data);
                } else {
                  onerror({ event });
                }
            ...
            xhr.onprogress = (event) => {
              ...
              try {
                if (event.lengthComputable) {
                  (_b3 = (_a4 = this.opt).batchProgress) == null ? void 0 : _b3.call(_a4, {
                    batch,
                    loaded: event.loaded,
                    total: event.total
                  });
            ...
            try {
              (_b2 = (_a3 = this.opt).errorHandler) == null ? void 0 : _b2.call(_a3, data);
            } finally {
              reject(data);
            }
          }
        ...
        (_d = (_c = this.opt).batchStop) == null ? void 0 : _d.call(_c, { batch });
      }
    });
  }
};
...
_Uploader.errorHandler = (data) => {
  ...
  if (data == null ? void 0 : data.exception) {
    ...
    notifyError((_c = (_b = (_a2 = data.exception).toString) == null ? void 0 : _b.call(_a2)) != null ? _c : "Exception occured!");
    return;
  }
...
var _Validator = class _Validator {
  constructor(form, options) {
    ...
    if (this.settings.onsubmit) {
      ...
      Fluent.on(this.currentForm, "click.validator", selector, (event) => {
        ...
        var button = ((_b = (_a2 = event.currentTarget) == null ? void 0 : _a2.matches) == null ? void 0 : _b.call(_a2, selector)) ? event.currentTarget : (_e = (_d = (_c = event.target).closest) == null ? void 0 : _d.call(_c, selector)) != null ? _e : event.target;
        ;
  ...
  static getInstance(element) {
    ...
    let form = (_a2 = element.closest) == null ? void 0 : _a2.call(element, "form");
  ...
  static getLength(value, element) {
    ...
    if (element instanceof HTMLInputElement && _Validator.isCheckOrRadio(element)) {
      ...
      return Array.from((_a2 = element.form) == null ? void 0 : _a2.querySelectorAll(`[name=${element.name}]`)).filter((x) => x.checked).length || 0;
    }
  ...
  static elementValue(element) {
    ...
    if (element instanceof HTMLInputElement) {
      ...
      if (element.type === "file") {
        val = (_a2 = element.value) != null ? _a2 : "";
    ...
    if (this.settings.focusInvalid) {
      try {
        ...
        if (lastActive && Fluent.isVisibleLike(lastActive)) {
          (_a2 = lastActive.focus) == null ? void 0 : _a2.call(lastActive);
  ...
  elements() {
    ...
    return Array.from(this.currentForm.querySelectorAll("input, select, textarea, [contenteditable]")).filter((x) => {
      ...
      if ((x instanceof HTMLButtonElement || x instanceof HTMLInputElement) && (x.type === "submit" || x.type === "reset" || x.type === "image"))
        return false;
      if (x.disabled || ((_a2 = x.closest("fieldset")) == null ? void 0 : _a2.disabled))
        return false;
  ...
  showLabel(element, message) {
    ...
    this.errorsFor(element).forEach((element2) => {
      var _a2, _b;
      if ((_b = (_a2 = element2 == null ? void 0 : element2.parentNode) == null ? void 0 : _a2.classList) == null ? void 0 : _b.contains("vx")) {
...
function addValidationRule(element, rule, uniqueName) {
  ...
  (_a2 = rules[uniqueName]) != null ? _a2 : rules[uniqueName] = [];
...
function groupBy(items, getKey) {
  ...
  for (var index = 0; index < items.length; index++) {
    ...
    let key = (_a2 = getKey(item)) != null ? _a2 : "";
...
((ScriptData2) => {
  function bindToChange(name, onChange) {
    if (typeof document !== "undefined" && document.addEventListener) {
      var unbind = function() {
        var _a2;
        onChange && typeof document !== "undefined" && ((_a2 = document.removeEventListener) == null ? void 0 : _a2.call(document, "scriptdatachange." + name, onChange));
        onChange = null;
      };
  ...
  function ensure(name, dynJS) {
    ...
    if (data != null)
      return data;
    var url = resolveUrl(dynJS ? "~/DynJS.axd/" : "~/DynamicData/") + name + (dynJS ? ".js" : "") + "?v=" + ((_a2 = getScriptDataHash(name)) != null ? _a2 : (/* @__PURE__ */ new Date()).getTime());
    var xhr = new XMLHttpRequest();
...
Object.defineProperty(Authorization, "isLoggedIn", {
  get: function() {
    var _a2;
    return !!((_a2 = Authorization.userDefinition) == null ? void 0 : _a2.Username);
  },
  configurable: true
});
Object.defineProperty(Authorization, "isLoggedInAsync", {
  get: function() {
    return __async(this, null, function* () {
      var _a2;
      return !!((_a2 = yield Authorization.userDefinitionAsync) == null ? void 0 : _a2.Username);
    });
  },
  configurable: true
});
...
function parseHourAndMin(value) {
  var _a2;
  let v = (_a2 = value == null ? void 0 : value.trim()) != null ? _a2 : "";
  if (!v.length)
    return null;
...
function parseDayHourAndMin(s) {
  var _a2;
  let days;
  let v = (_a2 = s == null ? void 0 : s.trim()) != null ? _a2 : "";
  if (!v.length)
    return null;
  let p = v.split(".");
  if (p.length == 1) {
...
function addOption(select, key, text2) {
  ...
  (_a2 = isArrayLike(select) ? select[0] : select) == null ? void 0 : _a2.append(option);
}
...
function findElementWithRelativeId(element, relativeId, context) {
  ...
  let fromId = (_a2 = from.id) != null ? _a2 : "";
  while (true) {
...
((Router2) => {
  ...
  function isIgnoredDialog(el) {
    var _a2, _b;
    return !!((el == null ? void 0 : el.closest(ignoredSelector)) || ((_b = (_a2 = Dialog.getInstance(el)) == null ? void 0 : _a2.getContentNode()) == null ? void 0 : _b.closest(ignoredSelector)));
  }
  ...
  function onDialogOpen(ownerEl, element, dialogHash) {
    ...
    if (ownerDlgInst) {
      ...
      if (!ownerIsDialog) {
        idPrefix = (_a2 = ownerDlgInst == null ? void 0 : ownerDlgInst.getContentNode()) == null ? void 0 : _a2.getAttribute("id");
        if (idPrefix) {
          idPrefix += "_";
      ...
      let closeMessages = function() {
        ...
        Array.from(document.querySelectorAll(".s-MessageDialog")).reverse().forEach((x) => {
          ...
          if (Fluent.isVisibleLike(x)) {
            (_a3 = Dialog.getInstance(x)) == null ? void 0 : _a3.close();
          }
        });
      };
      newHash = (_a2 = newHash != null ? newHash : window.location.hash) != null ? _a2 : "";
      if (newHash.charAt(0) == "#")
  ...
  function hashChange(e, o) {
    if (ignoreHash > 0) {
      if ((/* @__PURE__ */ new Date()).getTime() - ignoreTime > 1e3) {
        ignoreHash = 0;
      } else {
        ignoreHash--;
        return;
  ...
  function ignoreChange() {
    ignoreHash++;
    ignoreTime = (/* @__PURE__ */ new Date()).getTime();
  }
  ...
  if (typeof document !== "undefined") {
    let onDocumentDialogOpen = function(event) {
      ...
      if (dlg.dataset.qroute)
        return;
      dlg.dataset.qprhash = (_a2 = resolvingPreRoute != null ? resolvingPreRoute : pendingDialogPreHash) != null ? _a2 : window.location.hash;
      ...
      if (isIgnoredDialog(e.target))
        return false;
      if (((_b = (_a2 = e.target) == null ? void 0 : _a2.closest) == null ? void 0 : _b.call(_a2, ".s-MessageDialog, .s-MessageModal")) || e.key === "Escape")
        return true;
  ...
  if (widgetOrType == null ? void 0 : widgetOrType.domNode) {
    ...
    if (defaultElement) {
      if (typeof props.element === "function") {
        ...
        (_a2 = props.element) != null ? _a2 : props.element = defaultElement;
      }
    }
...
function initFullHeightGridPage(gridDiv, opt) {
  ...
  let setHeight = (_a2 = opt == null ? void 0 : opt.setHeight) != null ? _a2 : getjQuery() && (!el.classList.contains("s-DataGrid") && !el.classList.contains("s-Panel"));
  let layout = function() {
...
function isMobileView() {
  var _a2, _b, _c;
  return typeof window !== "undefined" && ((_c = (_b = (_a2 = window.matchMedia) == null ? void 0 : _a2.call(window, "(max-width: 767px)")) == null ? void 0 : _b.matches) != null ? _c : window.innerWidth < 768);
}
function initOnLoad() {
...
function centerDialog(el) {
  ...
  if (!dlg)
    return;
  dlg = getjQuery()(dlg);
  (_a2 = dlg.position) == null ? void 0 : _a2.call(dlg, { at: "center center", of: window });
...
var trimEnd = function(s) {
  var _a2, _b, _c;
  return (_c = (_b = (_a2 = s != null ? s : "").trimEnd) == null ? void 0 : _b.call(_a2)) != null ? _c : s.replace(/\s*$/, "");
};
var trimStart = function(s) {
  var _a2, _b, _c;
  return (_c = (_b = (_a2 = s != null ? s : "").trimStart) == null ? void 0 : _b.call(_a2)) != null ? _c : s.replace(/^\s*/, "");
};
function trim(s) {
  var _a2;
  return (_a2 = s == null ? void 0 : s.trim()) != null ? _a2 : "";
}
...
function replaceAll(str, find, replace) {
  var _a2, _b;
  str = str || "";
  return (_b = (_a2 = str.replaceAll) == null ? void 0 : _a2.call(str, find, replace)) != null ? _b : str.split(find).join(replace);
}
...
function validateOptions(options) {
  ...
  return extend(extend(opt, {
    errorPlacement: function(place, elem) {
      ...
      (_a2 = field == null ? void 0 : field.append) == null ? void 0 : _a2.call(field, isArrayLike(place) ? place[0] : place);
    },
    ...
    invalidHandler: function(event, validator) {
      ...
      validator.errorList.forEach((x) => {
        ...
        (_b2 = (_a3 = element.closest(".category.collapsed")) == null ? void 0 : _a3.querySelectorAll(
      ...
      if (validator.errorList.length) {
        ...
        if (!el)
          return;
        let $2 = getjQuery();
        var bsPaneId = (_a2 = el.closest(".tab-content>.tab-pane[id]:not(.active)")) == null ? void 0 : _a2.getAttribute("id");
        if (bsPaneId) {
...
((AggregateFormatting2) => {
  function formatMarkup(totals, column, aggType) {
    ...
    var text2 = (_a2 = tryGetText("Enums.Serenity.SummaryType." + textKey)) != null ? _a2 : textKey;
  ...
  function formatValue(column, value) {
    var _a2, _b, _c;
    var formatter = (_a2 = column.format) != null ? _a2 : column.formatter ? convertCompatFormatter(column.formatter) : null;
    if (formatter != null) {
...
var RemoteView = class {
  constructor(options) {
    ...
    var localSort = (_a2 = options.localSort) != null ? _a2 : false;
    var intf;
...
EnumKeyAttribute = __decorateClass([
  attr("EnumKey")
], EnumKeyAttribute);
...
DisplayNameAttribute = __decorateClass([
  attr("DisplayName")
...
CategoryAttribute = __decorateClass([
  attr("Category")
], CategoryAttribute);
...
ColumnsKeyAttribute = __decorateClass([
  attr("ColumnsKey")
], ColumnsKeyAttribute);
...
CloseButtonAttribute = __decorateClass([
  attr("CloseButton")
...
CssClassAttribute = __decorateClass([
  attr("CssClass")
], CssClassAttribute);
...
DefaultValueAttribute = __decorateClass([
  attr("DefaultValue")
...
DialogTypeAttribute = __decorateClass([
  attr("DialogType")
], DialogTypeAttribute);
...
EditorOptionAttribute = __decorateClass([
  attr("EditorOption")
...
var EditorTypeAttribute = class extends EditorTypeAttributeBase {
  constructor(editorType) {
    super(editorType);
  }
};
EditorTypeAttribute = __decorateClass([
  attr("EditorType")
], EditorTypeAttribute);
...
ElementAttribute = __decorateClass([
  attr("Element")
], ElementAttribute);
...
EntityTypeAttribute = __decorateClass([
  attr("EntityType")
], EntityTypeAttribute);
...
FilterableAttribute = __decorateClass([
  attr("Filterable")
], FilterableAttribute);
...
FlexifyAttribute = __decorateClass([
  attr("Flexify")
], FlexifyAttribute);
...
FormKeyAttribute = __decorateClass([
  attr("FormKey")
], FormKeyAttribute);
...
GeneratedCodeAttribute = __decorateClass([
  attr("GeneratedCode")
...
HiddenAttribute = __decorateClass([
  attr("Hidden")
], HiddenAttribute);
...
IdPropertyAttribute = __decorateClass([
  attr("IdProperty")
], IdPropertyAttribute);
...
InsertableAttribute = __decorateClass([
  attr("Insertable")
], InsertableAttribute);
...
IsActivePropertyAttribute = __decorateClass([
...
ItemNameAttribute = __decorateClass([
  attr("ItemName")
], ItemNameAttribute);
...
LocalTextPrefixAttribute = __decorateClass([
...
MaximizableAttribute = __decorateClass([
  attr("Maximizable")
...
MaxLengthAttribute = __decorateClass([
  attr("MaxLength")
], MaxLengthAttribute);
...
NamePropertyAttribute = __decorateClass([
  attr("NameProperty")
], NamePropertyAttribute);
var OneWayAttribute = class {
};
OneWayAttribute = __decorateClass([
  attr("OneWay")
], OneWayAttribute);
var OptionAttribute = class {
};
OptionAttribute = __decorateClass([
  attr("Option")
], OptionAttribute);
...
OptionsTypeAttribute = __decorateClass([
  attr("OptionsType")
...
PanelAttribute = __decorateClass([
  attr("Panel")
], PanelAttribute);
...
PlaceholderAttribute = __decorateClass([
  attr("Placeholder")
...
ReadOnlyAttribute = __decorateClass([
  attr("ReadOnly")
], ReadOnlyAttribute);
...
RequiredAttribute = __decorateClass([
  attr("Required")
], RequiredAttribute);
...
ResizableAttribute = __decorateClass([
  attr("Resizable")
], ResizableAttribute);
...
ResponsiveAttribute = __decorateClass([
  attr("Responsive")
], ResponsiveAttribute);
...
ServiceAttribute = __decorateClass([
  attr("Service")
], ServiceAttribute);
...
StaticPanelAttribute = __decorateClass([
  attr("StaticPanel")
...
UpdatableAttribute = __decorateClass([
  attr("Updatable")
], UpdatableAttribute);
...
IValidateRequired = __decorateClass([
...
function commonTypeRegistry(isMatch, attrKey, suffix) {
  ...
  function tryGet(key) {
    ...
    if (type == null && suffix && !key.endsWith(suffix))
      type = (_a2 = knownTypes[key + suffix]) != null ? _a2 : search(key + suffix);
    if (type) {
      knownTypes[key] = type;
      var akey = attrKey && attrKey(type);
      if (akey && key != akey)
...
from the project folder.`;
  ...
  DialogTypeRegistry2.get = get;
  function reset() {
    registry.reset();
  }
  DialogTypeRegistry2.reset = reset;
  function tryGet(key) {
    return registry.tryGet(key);
  }
  DialogTypeRegistry2.tryGet = tryGet;
...
function getWidgetName(type) {
  var _a2;
  return (_a2 = getTypeFullName(type)) == null ? void 0 : _a2.replace(/\./g, "_");
}
...
function tryGetWidget(element, type) {
  ...
  if (!keys.length)
    return null;
  if (!type)
    return (_a2 = widgets[keys[0]]) != null ? _a2 : null;
...
function getWidgetFrom(element, type) {
  ...
  if (!element)
    throw new Error(`Searching for widget of type '${(_a2 = getTypeFullName(type)) != null ? _a2 : "Widget"}' on a non-existent element! (${selector != null ? selector : "unknown"})`);
...
function focus($el) {
  ...
  window.setTimeout(function() {
    var _a2;
    var el = $el, pos = ((_a2 = $el.value) == null ? void 0 : _a2.length) || 0, range;
    $el.focus();
...
function syncCssClasses(dest, src, adapter) {
  ...
  classes = (_a2 = dest.getAttribute("class")) == null ? void 0 : _a2.trim();
  if (classes) {
    classes = "" + classes;
...
var _Select2 = class _Select2 {
  ...
  close() {
    var _a2;
    (_a2 = this.instance) == null ? void 0 : _a2.close();
  }
  get container() {
    var _a2;
    return (_a2 = this.instance) == null ? void 0 : _a2.container;
  }
  get dropdown() {
    var _a2;
    return (_a2 = this.instance) == null ? void 0 : _a2.dropdown;
  }
  destroy() {
    var _a2;
    (_a2 = this.instance) == null ? void 0 : _a2.destroy();
  }
  get data() {
    var _a2;
    return (_a2 = this.instance) == null ? void 0 : _a2.data();
  }
  set data(value) {
    var _a2;
    (_a2 = this.instance) == null ? void 0 : _a2.data(value);
  }
  disable() {
    var _a2;
    (_a2 = this.instance) == null ? void 0 : _a2.disable();
  }
  enable(enabled) {
    var _a2;
    (_a2 = this.instance) == null ? void 0 : _a2.enable(enabled);
  }
  focus() {
    var _a2;
    (_a2 = this.instance) == null ? void 0 : _a2.focus();
  }
  get isFocused() {
    var _a2;
    return (_a2 = this.instance) == null ? void 0 : _a2.isFocused();
  }
  get isMultiple() {
  ...
  get opened() {
    var _a2;
    return (_a2 = this.instance) == null ? void 0 : _a2.opened();
  }
  open() {
    var _a2;
    return (_a2 = this.instance) == null ? void 0 : _a2.open();
  }
  positionDropdown() {
    var _a2;
    (_a2 = this.instance) == null ? void 0 : _a2.positionDropdown();
  }
  readonly(value) {
    var _a2;
    (_a2 = this.instance) == null ? void 0 : _a2.readonly(value);
  }
  get search() {
    var _a2;
    return (_a2 = this.instance) == null ? void 0 : _a2.search;
  }
  get val() {
    var _a2;
    return (_a2 = this.instance) == null ? void 0 : _a2.val();
  }
  set val(value) {
    var _a2;
    (_a2 = this.instance) == null ? void 0 : _a2.val(value);
  }
  static getInstance(el) {
    if (!el || !el.select2)
      return null;
  ...
  return function(query) {
    ...
    process = function(datum, collection) {
      ...
      if (datum.children) {
        group = {};
        for (attr2 in datum) {
          if (datum.hasOwnProperty(attr2))
            group[attr2] = datum[attr2];
        }
        group.children = [];
...
var AbstractSelect2 = class {
  init(opts) {
    ...
    if (opts.element.select2 != null) {
      (_b = (_a2 = opts.element.select2).destroy) == null ? void 0 : _b.call(_a2);
    }
    ...
    ["touchstart", "touchmove", "touchend"].forEach(
      (ev) => Fluent.on(this.dropdown, "touchstart touchmove touchend", resultsSelector, (event) => {
  ...
  destroy() {
    ...
    this._sync = null;
    if (select2 !== void 0) {
      (_a2 = select2.container) == null ? void 0 : _a2.remove();
  ...
  opening() {
    ...
    var dropdownParent = (_a2 = typeof this.opts.dropdownParent === "function" ? this.opts.dropdownParent(this.opts.element) : null) != null ? _a2 : document == null ? void 0 : document.body;
  ...
  close() {
    ...
    (_a2 = this.search.parentElement) == null ? void 0 : _a2.classList.remove("select2-active");
  ...
  highlight(index) {
    ...
    this.search.setAttribute("aria-activedescendant", (_a2 = choice == null ? void 0 : choice.querySelector(".select2-result-label")) == null ? void 0 : _a2.getAttribute("id"));
  ...
  highlightUnderEvent(event) {
    var _a2, _b;
    var el = (_b = (_a2 = event.target) == null ? void 0 : _a2.closest) == null ? void 0 : _b.call(_a2, ".select2-result-selectable");
  ...
  updateResults(initial) {
    ...
    function postRender() {
      ...
      (_a3 = search.parentElement) == null ? void 0 : _a3.classList.remove("select2-active");
      self2.positionDropdown();
    }
    ...
    if (((_a2 = search.value) == null ? void 0 : _a2.length) < opts.minimumInputLength) {
  ...
  selectHighlighted(options) {
    ...
    var index = this.highlight(), highlighted = this.results.querySelector(".select2-highlighted"), data = (_a2 = highlighted == null ? void 0 : highlighted.closest(".select2-result")) == null ? void 0 : _a2.select2data;
    if (data) {
      this.highlight(index);
  ...
  getPlaceholderOption() {
    ...
    if (this.select) {
      ...
      } else if (((_a2 = firstOption.textContent) == null ? void 0 : _a2.trim()) === "" && firstOption.value === "") {
        return firstOption;
      }
    }
  }
...
var SingleSelect2 = class extends AbstractSelect2 {
  ...
  opening() {
    ...
    if (this.search.value === "") {
      if (this.nextSearchTerm != void 0) {
        this.search.value = (_a2 = this.nextSearchTerm) != null ? _a2 : "";
        this.search.select();
      }
    }
  ...
  destroy() {
    var _a2;
    (_a2 = document.querySelector("label[for='" + this.focusser.getAttribute("id") + "']")) == null ? void 0 : _a2.setAttribute(
      "for",
  ...
  initContainer() {
    ...
    (_a2 = selection.querySelector(".select2-chosen")) == null ? void 0 : _a2.setAttribute("id", "select2-chosen-" + idSuffix);
    ...
    ["mousedown", "touchstart"].forEach((ev) => Fluent.on(selection, ev, "abbr", (e) => {
      if (!this.isInterfaceEnabled())
        return;
      this.clear();
  ...
  clear(triggerChange) {
    var _a2;
    var data = (_a2 = this.selection) == null ? void 0 : _a2.select2data;
    if (data) {
  ...
  setPlaceholder() {
    ...
    if (this.isPlaceholderOptionSelected() && placeholder !== void 0) {
      if (this.select && this.getPlaceholderOption() === void 0)
        return;
  ...
  showSearch(showSearchInput) {
    ...
    (_a2 = this.dropdown.querySelector(".select2-search")) == null ? void 0 : _a2.classList.toggle("select2-search-hidden", !showSearchInput);
  ...
  updateSelection(data) {
    ...
    if (this.opts.allowClear && this.getPlaceholder() !== void 0) {
      (_a2 = this.container) == null ? void 0 : _a2.classList.add("select2-allowclear");
    }
  }
  ...
  data(value) {
    ...
    if (arguments.length === 0) {
      data = (_a2 = this.selection) == null ? void 0 : _a2.select2data;
      if (data == void 0)
        data = null;
      return data;
    } else {
...
var MultiSelect2 = class extends AbstractSelect2 {
  ...
  destroy() {
    var _a2;
    (_a2 = document.querySelector("label[for='" + this.search.getAttribute("id") + "']")) == null ? void 0 : _a2.setAttribute(
      "for",
      this.opts.element.getAttribute("id")
    );
    super.destroy();
  ...
  initContainer() {
    ...
    this.search.previousElementSibling.textContent = (_a2 = document.querySelector("label[for='" + this.opts.element.getAttribute("id") + "']")) == null ? void 0 : _a2.textContent;
    this.search.previousElementSibling.setAttribute("for", this.search.getAttribute("id"));
    ["input", "paste"].forEach((ev) => Fluent.on(this.search, ev, () => {
      if (this.search.getAttribute("placeholder") && this.search.value.length === 0)
        return;
      if (!this.isInterfaceEnabled())
        return;
      if (!this.opened()) {
    ...
    Fluent.on(this.container, "click", selector, (e) => {
      ...
      if (!this.isInterfaceEnabled())
        return;
      if ((_a3 = e.target) == null ? void 0 : _a3.closest(".select2-search-choice")) {
        return;
      }
      this.selectChoice(null);
  ...
  onSelect(data, options) {
    ...
    if (this.select || !this.opts.closeOnSelect)
      this.postprocessResults(void 0, false, this.opts.closeOnSelect === true);
  ...
  addSelectedChoice(data) {
    ...
    if (enableChoice) {
      ...
      ["click", "dblclick"].forEach((ev) => Fluent.on(close, ev, (e) => {
        ...
        (_a2 = this.selection.querySelector(".select2-search-choice-focus")) == null ? void 0 : _a2.classList.remove("select2-search-choice-focus");
        killEvent(e);
        this.close();
        this.focusSearch();
      }));
...
var _Combobox = class _Combobox {
  ...
  createSelect2(opt) {
    ...
    select2Opt.query = (query) => {
      ...
      var searchQuery = {
        searchTerm: ((_a2 = query.term) == null ? void 0 : _a2.trim()) || null,
      ...
      function setActive(value) {
        var _a3, _b, _c;
        (_a3 = select2 == null ? void 0 : select2.search) == null ? void 0 : _a3.classList.toggle("select2-active", value);
    ...
    select2Opt.initSelection = (element, callback) => {
      ...
      el.initSelectionLoading && ((_b = (_a2 = el.initSelectionLoading) == null ? void 0 : _a2.abort) == null ? void 0 : _b.call(_a2));
  ...
  abortPendingQuery() {
    ...
    if (!this.el)
      return;
    this.el.queryLoading && ((_b = (_a2 = this.el.queryLoading) == null ? void 0 : _a2.abort) == null ? void 0 : _b.call(_a2));
  ...
  abortInitSelection() {
    ...
    if (!this.el)
      return;
    this.el.initSelection && ((_b = (_a2 = this.el.initSelection) == null ? void 0 : _a2.abort) == null ? void 0 : _b.call(_a2));
  ...
  dispose() {
    ...
    this.abortPendingQuery();
    (_a2 = Select2.getInstance(this.el)) == null ? void 0 : _a2.destroy();
  ...
  get container() {
    ...
    if (!this.el)
      return null;
    return (_a2 = Select2.getInstance(this.el)) == null ? void 0 : _a2.container;
  }
  get type() {
    if (!this.el)
      return null;
  ...
  closeDropdown() {
    var _a2;
    (_a2 = Select2.getInstance(this.el)) == null ? void 0 : _a2.close();
  }
  openDropdown() {
    var _a2;
    (_a2 = Select2.getInstance(this.el)) == null ? void 0 : _a2.open();
  }
  static getInstance(el) {
...
((EditorUtils2) => {
  function getDisplayText(editor) {
    ...
    if (value instanceof Boolean)
      return !!value ? (_a2 = tryGetText("Controls.FilterPanel.OperatorNames.true")) != null ? _a2 : "True" : (_b = tryGetText("Controls.FilterPanel.OperatorNames.true")) != null ? _b : "False";
...
var Widget = class {
  constructor(props) {
    ...
    this.idPrefix = (_b = (_a2 = this.options) == null ? void 0 : _a2.idPrefix) != null ? _b : this.uniqueName + "_";
    this.addCssClass();
  ...
  findById(id) {
    var _a2;
    return (_a2 = this.domNode) == null ? void 0 : _a2.querySelector("#" + this.idPrefix + id);
  }
  getGridField() {
  ...
  changeSelect2(handler) {
    Fluent.on(this.domNode, "change." + this.uniqueName, (e) => {
      var _a2, _b;
      if ((_b = (_a2 = e.target) == null ? void 0 : _a2.dataset) == null ? void 0 : _b.comboboxsettingvalue)
        return;
      handler(e);
    });
  }
  static create(params) {
    var _a2, _b, _c, _d;
    let props = (_a2 = params.options) != null ? _a2 : {};
  ...
  syncOrAsyncThen(syncMethod, asyncMethod, then) {
    var _a2;
    if (!((_a2 = this.useAsync) == null ? void 0 : _a2.call(this)))
...
Widget.typeInfo = Decorators.classType("Serenity.Widget");
Widget.nextWidgetNumber = 0;
Widget = __decorateClass([
...
from the project folder.`;
  ...
  EditorTypeRegistry2.get = get;
  function reset() {
    registry.reset();
  }
  EditorTypeRegistry2.reset = reset;
  function tryGet(key) {
    return registry.tryGet(key);
  }
  EditorTypeRegistry2.tryGet = tryGet;
...
((EnumTypeRegistry2) => {
  let registry = commonTypeRegistry(
    ...
    (type) => {
      var _a2;
      return (_a2 = getCustomAttribute(type, EnumKeyAttribute, false)) == null ? void 0 : _a2.value;
    },
    null
  );
  function get(key) {
...
After applying fixes, build and run "node ./tsbuild.js" (or "tsc" if using namespaces) from the project folder.`;
  ...
  EnumTypeRegistry2.get = get;
  function reset() {
    registry.reset();
  }
  EnumTypeRegistry2.reset = reset;
  function tryGet(key) {
    return registry.tryGet(key);
  }
  EnumTypeRegistry2.tryGet = tryGet;
      ...
      for (i = 0; (elem = cloned[i]) != null; i++) {
        try {
          ...
          if (events && events.remove) {
            ...
            for (var x of remove) {
              if (typeof (x == null ? void 0 : x.handler) === "function") {
                try {
...
function applyAjaxCSRFToken($2) {
  var _a2;
  (_a2 = $2 == null ? void 0 : $2.ajaxSetup) == null ? void 0 : _a2.call($2, {
...
function reactPatch() {
  ...
  if (!global5.React) {
    if (global5.preact) {
      ...
      global5.React.Fragment = (_a2 = global5.Fragment) != null ? _a2 : "x-fragment";
    } else {
      global5.React = {
        Component: function() {
        },
...
function ToolbarButton(tb) {
  var _a2;
  var cssClass = (_a2 = tb.cssClass) != null ? _a2 : "";
...
var Toolbar = class extends Widget {
  renderContents() {
...
((TabsExtensions2) => {
  ...
  function setDisabled(tabs, tabKey, isDisabled) {
    ...
    let $2 = getjQuery();
    if (!$2 || !((_b = (_a2 = $2(tabs)) == null ? void 0 : _a2.data) == null ? void 0 : _b.call(_a2).uiTabs)) {
  ...
  function toggle(tabs, tabKey, visible) {
    ...
    let $2 = getjQuery();
    if (!$2 || !((_b = (_a2 = $2(tabs)).data) == null ? void 0 : _b.call(_a2).uiTabs)) {
      var anchors = Array.from(tabs.querySelectorAll(navLinkSelector));
      if (index < anchors.length) {
  ...
  function activeTabKey(tabs) {
    ...
    let $2 = getjQuery();
    if (!$2 || !((_b = (_a2 = $2(tabs)).data) == null ? void 0 : _b.call(_a2).uiTabs)) {
      return extractTabKey(tabs.querySelector(navLinkSelectorActive));
    }
    return extractTabKey($2(tabs).children("ul").children("li").eq((_d = (_c = $2(tabs)).tabs) == null ? void 0 : _d.call(_c, "option", "active")).children("a")[0]);
  }
  TabsExtensions2.activeTabKey = activeTabKey;
  function extractTabKey(el) {
    if (!el)
      return "";
  ...
  function indexByKey(tabs) {
    ...
    tabs.querySelectorAll(navLinkSelector).forEach(function(el, index) {
      indexByKey2[extractTabKey(el)] = index;
    });
    return indexByKey2;
  }
  ...
  function initialize(tabs, activeChange) {
    ...
    if (!tabs)
      return null;
    let $2 = getjQuery();
    if ((_a2 = $2 == null ? void 0 : $2.fn) == null ? void 0 : _a2.tabs) {
...
function handleUIDialogResponsive(domNode) {
  ...
  if (!$2)
    return;
  var dlg = (_a2 = $2(domNode)) == null ? void 0 : _a2.dialog();
...
((DialogExtensions2) => {
  function dialogResizable(dialog, w, h, mw, mh) {
    ...
    if (!$2)
      return;
    var dlg = (_b = (_a2 = $2(dialog)) == null ? void 0 : _a2.dialog) == null ? void 0 : _b.call(_a2);
    if (!dlg)
      return;
  ...
  function dialogMaximizable(dialog) {
    ...
    if (!$2)
      return;
    (_b = (_a2 = $2(dialog)).dialogExtend) == null ? void 0 : _b.call(_a2, {
      closable: true,
      maximizable: true,
      dblclick: "maximize",
...
function registerDialogExtendPlugin() {
  ...
  if (!$2 || !$2.widget)
    return false;
  if ((_a2 = $2.fn) == null ? void 0 : _a2.dialogExtend)
    return true;
...
var BaseDialog = class extends Widget {
  static createDefaultElement() {
  ...
  isStaticPanel() {
    var _a2;
    return ((_a2 = this.getCustomAttribute(StaticPanelAttribute)) == null ? void 0 : _a2.value) === true;
  }
  getDialogOptions() {
    var _a2, _b, _c, _d, _e;
    return {
      preferPanel: this.isStaticPanel() ? true : (_a2 = this.getCustomAttribute(PanelAttribute)) == null ? void 0 : _a2.value,
      autoOpen: false,
      ...
      providerOptions: (type) => {
        ...
        if (type === "uidialog") {
          ...
          opt.resizable = (_a3 = this.getCustomAttribute(ResizableAttribute)) == null ? void 0 : _a3.value;
          return opt;
        }
      },
  ...
  initDialog() {
    ...
    if (((_a2 = this.dialog) == null ? void 0 : _a2.type) == "uidialog") {
      this.initUIDialog();
  ...
  initUIDialog() {
    ...
    if ((_a2 = this.getCustomAttribute(MaximizableAttribute)) == null ? void 0 : _a2.value) {
  ...
  initToolbar() {
    ...
    if (!toolbarDiv)
      return;
    var hotkeyContext = (_b = (_a2 = this.domNode.closest(".ui-dialog")) != null ? _a2 : this.domNode.closest(".modal")) != null ? _b : this.domNode;
  ...
  dialogClose(result) {
    var _a2;
    (_a2 = this.dialog) == null ? void 0 : _a2.close(result != null ? result : null);
  }
  get dialogTitle() {
    var _a2, _b;
    return (_b = (_a2 = this.dialog) == null ? void 0 : _a2.title()) != null ? _b : this.domNode.dataset.dialogtitle;
  }
  set dialogTitle(value) {
    var _a2;
    this.domNode.dataset.dialogtitle = value;
    (_a2 = this.dialog) == null ? void 0 : _a2.title(value != null ? value : "");
  }
  initTabs() {
...
var CascadedWidgetLink = class {
  constructor(parentType, widget, parentChange) {
    ...
    this.bind();
    Fluent.on(this.widget.domNode, "remove." + widget.uniqueName + "cwh", () => {
      this.unbind();
      this.widget = null;
...
CascadedWidgetLink = __decorateClass([
...
var PropertyGrid = class extends Widget {
  renderContents() {
    var _a2, _b, _c, _d;
    ...
    if (useTabs) {
      ...
      while (i < itemsWithTab.length) {
        var tabName = (_b = (_a2 = itemsWithTab[i].tab) == null ? void 0 : _a2.trim()) != null ? _b : "";
        var withSameTab = [];
        var j = i;
        do {
          withSameTab.push(itemsWithTab[j]);
        } while (++j < itemsWithTab.length && ((_d = (_c = itemsWithTab[j].tab) == null ? void 0 : _c.trim()) != null ? _d : "") === tabName);
        i = j;
        var tabId = this.uniqueName + "_Tab" + tabIndex;
        Fluent("li").class([!bs3 && "nav-item", bs3 && tabIndex === 0 && "active"]).append(Fluent("a").class([!bs3 && "nav-link", !bs3 && tabIndex === 0 && "active"]).attr("role", "tab").data((isBS5Plus() ? "bs-" : "") + "toggle", "tab").attr("href", "#" + tabId).text(this.determineText(tabName, (prefix) => prefix + "Tabs." + tabName))).appendTo(tabs);
        var pane = Fluent("div").class(["tab-pane fade", tabIndex === 0 && (isBS3() ? "in active" : "show active")]).attr("id", tabId).attr("role", "tabpanel").appendTo(panes);
  ...
  destroy() {
    ...
    if (this.editors) {
      for (var i = 0; i < this.editors.length; i++) {
        (_b = (_a2 = this.editors[i]) == null ? void 0 : _a2.destroy) == null ? void 0 : _b.call(_a2);
      }
      this.editors = null;
    }
    this.domNode.querySelectorAll("a.category-link").forEach((el) => {
      Fluent.off(el, "click." + this.uniqueName);
      el.remove();
    });
    super.destroy();
  }
  createItems(container, items) {
    var _a2, _b;
    var categoryIndexes = {};
    ...
    if (useCategories) {
      ...
      if (Object.keys(categoryIndexes).length > 1) {
        ...
        linkContainer.querySelectorAll("a.category-link").forEach((el) => {
          Fluent.off(el, "click." + this.uniqueName);
          el.remove();
        });
      }
    ...
    for (var i = 0; i < items.length; i++) {
      ...
      if (category == null) {
        category = (_a2 = this.options.defaultCategory) != null ? _a2 : "";
      }
      if (useCategories && priorCategory !== category) {
        var categoryDiv = this.createCategoryDiv(
          categoriesDiv,
          categoryIndexes,
          category,
          item.collapsible !== true ? null : (_b = item.collapsed) != null ? _b : false
        );
  ...
  createCategoryDiv(categoriesDiv, categoryIndexes, category, collapsed) {
    var categoryDiv = Fluent("div").class("category").appendTo(categoriesDiv);
    var title = Fluent("div").class("category-title").appendTo(categoryDiv).append(Fluent("a").class("category-anchor").attr("name", this.idPrefix + "Category" + categoryIndexes[category].toString())).append(this.determineText(category, (prefix) => prefix + "Categories." + category));
    if (collapsed != null) {
  ...
  categoryLinkClick(e) {
    var _a2, _b;
    e.preventDefault();
    var title = document.querySelector("a[name=" + e.target.getAttribute("href").toString().substring(1) + "]");
    if ((_a2 = title == null ? void 0 : title.closest(".category")) == null ? void 0 : _a2.classList.contains("collapsed"))
      (_b = title.closest(".category").querySelector(":scope > .category-title")) == null ? void 0 : _b.click();
    var animate = function() {
      var _a3, _b2;
      if ((_b2 = (_a3 = getjQuery()) == null ? void 0 : _a3.fn) == null ? void 0 : _b2.fadeTo) {
    ...
    let intoView = title == null ? void 0 : title.closest(".category");
    if (intoView == null ? void 0 : intoView.scrollIntoView) {
      intoView.scrollIntoView();
      animate();
    }
  }
  determineText(text2, getKey) {
    if (text2 != null && !text2.startsWith("`")) {
      var local2 = tryGetText(text2);
      if (local2 != null) {
        return local2;
  ...
  createField(container, item) {
    ...
    if (item.formCssClass) {
      ...
      if (item.formCssClass.indexOf("line-break-") >= 0) {
        ...
        const addLineBreak = (klass) => Fluent("div").class(klass).attr("style", "width: 100%").insertBefore(fieldDiv);
    ...
    var label = Fluent("label").class("caption").attr("for", editorId).attr("title", (_a2 = hint != null ? hint : title) != null ? _a2 : "").text(title != null ? title : "").appendTo(fieldDiv);
    if (item.labelWidth) {
    ...
    if (item.required) {
      Fluent("sup").text("*").attr("title", localText("Controls.PropertyGrid.RequiredHint")).prependTo(label);
    }
    var editorType = EditorTypeRegistry.get((_b = item.editorType) != null ? _b : "String");
    ...
    let editor = new editorType(__spreadProps(__spreadValues({}, editorParams), {
      id: editorId,
      element: (el) => {
        var _a3;
        Fluent(el).addClass("editor");
        if (Fluent.isInputLike(el))
          el.setAttribute("name", (_a3 = item.name) != null ? _a3 : "");
        if (placeHolder)
          el.setAttribute("placeholder", placeHolder);
        fieldDiv.append(el);
      }
    })).init();
    if (getTypeShortName(editor) == "BooleanEditor" && (item.editorParams == null || !!!item.editorParams["labelFor"])) {
      label.removeAttr("for");
    }
    if (getTypeShortName(editor) == "RadioButtonEditor" && (item.editorParams == null || !!!item.editorParams["labelFor"])) {
      label.removeAttr("for");
    }
  ...
  getCategoryOrder(items) {
    var _a2, _b;
    var order = 0;
    var result = {};
    var categoryOrder = ((_a2 = this.options.categoryOrder) == null ? void 0 : _a2.trim()) || null;
    if (categoryOrder != null) {
      var split = categoryOrder.split(";");
      for (var s of split) {
        var x = (s == null ? void 0 : s.trim()) || null;
        if (x == null) {
          continue;
        }
        if (result[x] != null) {
    ...
    for (var x1 of items) {
      ...
      if (category == null) {
        category = (_b = this.options.defaultCategory) != null ? _b : "";
      }
  ...
  createCategoryLinks(container, items) {
    var _a2;
    var idx = 0;
    var itemIndex = {};
    var itemCategory = {};
    for (var x of items) {
      ...
      var cat1 = x.category;
      if (cat1 == null) {
        cat1 = (_a2 = this.options.defaultCategory) != null ? _a2 : "";
      }
    ...
    for (var i = 0; i < items.length; i++) {
      ...
      if (categoryIndexes[category] == null) {
        ...
        Fluent("a").class("category-link").text(this.determineText(category, (prefix) => prefix + "Categories." + category)).attr("tabindex", "-1").attr("href", `#${this.idPrefix}Category${index}`).on("click." + this.uniqueName, this.categoryLinkClick.bind(this)).prependTo(container);
      }
    }
  ...
  static setMaxLength(widget, maxLength) {
  ...
  load(source) {
    for (var i = 0; i < this.editors.length; i++) {
      ...
      if (!!(this.get_mode() === 1 && item.defaultValue != null) && typeof source[item.name] === "undefined") {
  ...
  updateInterface() {
    for (var i = 0; i < this.editors.length; i++) {
      ...
      EditorUtils.setRequired(editor, !readOnly && !!item.required && item.editorType !== "Boolean");
      if (item.visible === false || item.readPermission != null || item.insertPermission != null || item.updatePermission != null || item.hideOnInsert === true || item.hideOnUpdate === true) {
        var hidden = item.readPermission != null && !Authorization.hasPermission(item.readPermission) || item.visible === false || this.get_mode() === 1 /* insert */ && item.hideOnInsert === true || this.get_mode() === 2 && item.hideOnUpdate === true;
...
var PropertyPanel = class extends BasePanel {
  constructor(props) {
    super(props);
...
var PropertyDialog = class extends BaseDialog {
  isClosable() {
  ...
  getDialogButtons() {
    var _a2;
    if (((_a2 = this.getCustomAttribute(StaticPanelAttribute)) == null ? void 0 : _a2.value) === true)
      return [];
    return [
      okDialogButton({
        click: (e) => {
  ...
  getPropertyItems() {
    var _a2;
    return ((_a2 = this.propertyItemsData) == null ? void 0 : _a2.items) || [];
  }
  getPropertyItemsData() {
    var formKey = this.getFormKey();
    if (this.getFormKey === PropertyDialog.prototype.getFormKey && this.getPropertyItems !== PropertyDialog.prototype.getPropertyItems && !ScriptData.canLoad("Form." + formKey)) {
      return {
        items: this.getPropertyItems(),
        additionalItems: []
      };
...
var TextAreaEditor = class extends EditorWidget {
  ...
  constructor(props) {
    ...
    if (this.options.cols !== 0) {
      input.attr("cols", (_a2 = this.options.cols) != null ? _a2 : 80);
    }
...
function runCallbacks(input, settings) {
  Object.keys(settings).forEach(function(k) {
    ...
    } else if (typeof ((_a2 = AutoNumeric.getSettings(input)) == null ? void 0 : _a2[val]) === "function") {
...
var AutoNumeric = class _AutoNumeric {
  static init(input, options) {
    ...
    if (!((_a2 = settings.tagList) == null ? void 0 : _a2.includes(input.tagName)) && input.tagName !== "INPUT") {
  ...
  static setValue(input, valueIn) {
    ...
    if (!((_a2 = settings.tagList) == null ? void 0 : _a2.includes(input.tagName))) {
  ...
  static getValue(input) {
    ...
    } else if ((_a2 = settings.tagList) == null ? void 0 : _a2.includes(input.tagName)) {
...
var DecimalEditor = class extends EditorWidget {
  static createDefaultElement() {
    return Fluent("input").attr("type", "text").getNode();
  }
  constructor(props) {
  ...
  getAutoNumericOptions() {
    ...
    var numericOptions = Object.assign({}, DecimalEditor.defaultAutoNumericOptions(), {
      vMin: (_a2 = this.options.minValue) != null ? _a2 : this.options.allowNegatives ? this.options.maxValue != null ? "-" + this.options.maxValue : "-999999999999.99" : "0.00",
...
var IntegerEditor = class extends EditorWidget {
  ...
  getAutoNumericOptions() {
    var _a2, _b;
    var numericOptions = Object.assign({}, DecimalEditor.defaultAutoNumericOptions(), {
      vMin: (_a2 = this.options.minValue) != null ? _a2 : this.options.allowNegatives ? this.options.maxValue != null ? "-" + this.options.maxValue : "-2147483647" : "0",
  ...
  get_value() {
    ...
    if (AutoNumeric.hasInstance(this.domNode)) {
      ...
      val = (_a2 = this.domNode.value) == null ? void 0 : _a2.trim();
      if (!val)
        return null;
...
function dateInputChangeHandler(e) {
  ...
  if ((input == null ? void 0 : input.getAttribute("type")) === "date")
    return;
  var val = (_a2 = input.value) != null ? _a2 : "";
...
function flatPickrTrigger(input) {
  ...
  button.addEventListener("click", () => {
    ...
    if (!input.classList.contains("readonly") && input.getAttribute("readonly") == null) {
      (_b = (_a2 = input._flatpickr) == null ? void 0 : _a2.open) == null ? void 0 : _b.call(_a2);
...
function jQueryDatepickerInitialization() {
  var _a2, _b;
  let $2 = getjQuery();
  if (!((_b = (_a2 = $2 == null ? void 0 : $2.datepicker) == null ? void 0 : _a2.regional) == null ? void 0 : _b.en))
    return false;
...
var DateEditor = class extends EditorWidget {
  static createDefaultElement() {
    return Fluent("input").attr("type", "text").getNode();
  }
  constructor(props) {
    ...
    super(props);
    let $2 = getjQuery();
    if (typeof flatpickr !== "undefined" && (DateEditor.useFlatpickr || !((_a2 = $2 == null ? void 0 : $2.fn) == null ? void 0 : _a2.datepicker))) {
  ...
  get_value() {
    var _a2;
    var value = (_a2 = this.domNode.value) == null ? void 0 : _a2.trim();
    if (!value) {
      return null;
    }
  ...
  getFlatpickrOptions(input) {
    var opt = {
      ...
      disable: [
        (d) => {
          var _a2;
          return this.get_readOnly() && formatDate(d, "d") != formatDate((_a2 = this.domNode) == null ? void 0 : _a2.value, "d");
        }
      ]
    };
...
var DateTimeEditor = class extends EditorWidget {
  static createDefaultElement() {
    return Fluent("input").attr("type", "text").getNode();
  }
  constructor(props) {
    ...
    } else if (typeof flatpickr !== "undefined" && (DateEditor.useFlatpickr || !((_a2 = $2 == null ? void 0 : $2.fn) == null ? void 0 : _a2.datepicker) || this.options.seconds)) {
      this.domNode.classList.add("dateTimeQ");
    ...
    Fluent.on(this.domNode, "keyup." + this.uniqueName, (e) => {
      ...
      if (this.time) {
        if (e.key === " ") {
          if (this.get_valueAsDate() !== /* @__PURE__ */ new Date()) {
  ...
  getFlatpickrOptions() {
    ...
    var opt = {
      ...
      minuteIncrement: (_a2 = this.options.intervalMinutes) != null ? _a2 : 5,
      ...
      disable: [
        (d) => {
          var _a3;
          return this.get_readOnly() && formatDate(d, "d") != formatDate((_a3 = this.domNode) == null ? void 0 : _a3.value, "d");
        }
      ]
    };
    if (this.domNode.closest(".modal"))
  ...
  set_value(value) {
    ...
    if (!value) {
      ...
      if (this.time) {
        val = DateTimeEditor.roundToMinutes(val, (_a2 = this.options.intervalMinutes) != null ? _a2 : 5);
  ...
  getInplaceNowText() {
    var _a2;
    return (_a2 = tryGetText("Controls.DateTimeEditor.SetToNow")) != null ? _a2 : "set to now";
  }
  getDisplayFormat() {
...
var EmailAddressEditor = class extends StringEditor {
  ...
  constructor(props) {
    var _a2;
    super(props);
    (_a2 = this.domNode) == null ? void 0 : _a2.classList.add("email");
  }
};
EmailAddressEditor = __decorateClass([
  Decorators.registerEditor("Serenity.EmailAddressEditor")
], EmailAddressEditor);

// src/ui/editors/urleditor.ts
var URLEditor = class extends StringEditor {
  constructor(props) {
    super(props);
  ...
  constructor(props) {
    ...
    if (this.options.lookupKey) {
      ...
      for (var x of values) {
        ...
        this.addRadio(x.toString(), (_a2 = tryGetText(
          "Enums." + enumKey + "." + name
        )) != null ? _a2 : name);
      }
    }
...
var ComboboxEditor = class extends Widget {
  ...
  destroy() {
    var _a2;
    (_a2 = this.combobox) == null ? void 0 : _a2.dispose();
    this.combobox = null;
    super.destroy();
  }
  hasAsyncSource() {
  ...
  getTypeDelay() {
    var _a2;
    return (_a2 = this.options["typeDelay"]) != null ? _a2 : 200;
  }
  emptyItemText() {
    var _a2;
    return (_a2 = this.domNode.getAttribute("placeholder")) != null ? _a2 : localText("Controls.SelectEditor.EmptyItemText");
  }
  getPageSize() {
    var _a2;
    return (_a2 = this.options["pageSize"]) != null ? _a2 : 100;
  }
  getIdField() {
  ...
  getTextField() {
    var _a2;
    return (_a2 = this.options["textField"]) != null ? _a2 : this.getIdField();
  }
  itemText(item) {
  ...
  abortPendingQuery() {
    var _a2;
    (_a2 = this.combobox) == null ? void 0 : _a2.abortPendingQuery();
  }
  getComboboxOptions() {
    var emptyItemText = this.emptyItemText();
    var opt = {
    ...
    if (this.hasAsyncSource()) {
      opt.search = (query) => this.asyncSearch(query).then((result) => {
        ...
        (_a2 = this._itemById) != null ? _a2 : this._itemById = {};
        for (var x of items)
      ...
      opt.search = (query) => {
        ...
        if (query.initSelection) {
          items = this._items.filter((x) => {
            var _a3;
            return (_a3 = query.idList) == null ? void 0 : _a3.includes(x.id);
          });
        } else {
  ...
  addInplaceCreate(addTitle, editTitle) {
    ...
    (_a2 = this.getComboboxContainer()) == null ? void 0 : _a2.classList.add("has-inplace-button");
    ...
    if (this.isMultiple()) {
      Fluent.on(this.getComboboxContainer(), "dblclick." + this.uniqueName, ".select2-search-choice", (e3) => {
        ...
        var index = Array.from(((_a3 = q.parent().getNode()) == null ? void 0 : _a3.children) || []).indexOf(q.getNode());
  ...
  getCreateSearchChoice(getName) {
    return (s) => {
      ...
      s = ((_a2 = stripDiacritics(s)) != null ? _a2 : "").toLowerCase();
      if (isTrimmedEmpty(s)) {
        return null;
      }
      ...
      if (!(this._items || []).some((x1) => {
        var _a3;
        return ((_a3 = stripDiacritics(x1.text)) != null ? _a3 : "").toLowerCase().indexOf(s) !== -1;
      })) {
  ...
  getComboboxContainer() {
    var _a2;
    return (_a2 = Combobox.getInstance(this.domNode)) == null ? void 0 : _a2.container;
  }
  get_items() {
    return this.items;
  }
  ...
  get_value() {
    var _a2;
    return this.combobox ? this.combobox.getValue() : (_a2 = this.domNode) == null ? void 0 : _a2.value;
  }
  get value() {
    return this.get_value();
  }
  ...
  get_values() {
    var _a2;
    return (_a2 = this.combobox) == null ? void 0 : _a2.getValues();
  }
  get values() {
  ...
  set_values(value) {
    var _a2;
    (_a2 = this.combobox) == null ? void 0 : _a2.setValues(value);
  }
  set values(value) {
  ...
  get_text() {
    ...
    if (combobox)
      return (_a2 = combobox.getSelectedItems()) == null ? void 0 : _a2.map((x) => x.text).join(", ");
    return this.domNode.value;
  }
  get text() {
  ...
  get_cascadeField() {
    var _a2;
    return (_a2 = this.options.cascadeField) != null ? _a2 : this.options.cascadeFrom;
  }
  get cascadeField() {
  ...
  cascadeItems(items) {
    ...
    return items.filter((x) => {
      var _a2;
      var itemKey = (_a2 = x[fld]) != null ? _a2 : ReflectionUtils.getPropertyValue(x, fld);
  ...
  setTermOnNewEntity(entity, term) {
  }
  inplaceCreateClick(e) {
    ...
    this.createEditDialog((dialog) => {
      ...
      if (editItem != null) {
        ...
        var entity = {};
        this.setTermOnNewEntity(entity, (_b = (_a2 = this.lastCreateTerm) == null ? void 0 : _a2.trim()) != null ? _b : "");
  ...
  openDropdown() {
    var _a2;
    (_a2 = Combobox.getInstance(this.domNode)) == null ? void 0 : _a2.openDropdown();
  }
};
ComboboxEditor = __decorateClass([
...
var SelectEditor = class extends ComboboxEditor {
  constructor(props) {
    super(props);
    this.updateItems();
  }
  ...
  updateItems() {
    ...
    if (items.length > 0) {
      ...
      for (var item of items) {
        ...
        var text2 = isStrings ? item : (_a2 = item[1]) != null ? _a2 : item[0];
        this.addOption(key, text2, item, false);
      }
    }
  }
};
SelectEditor = __decorateClass([
  Decorators.registerClass("Serenity.SelectEditor")
], SelectEditor);

// src/ui/editors/dateyeareditor.ts
var DateYearEditor = class extends SelectEditor {
  constructor(props) {
    super(props);
    this.updateItems();
  }
  getItems() {
    ...
    opt.minYear = ((_a2 = opt.minYear) != null ? _a2 : "-10").toString();
...
var EnumEditor = class extends ComboboxEditor {
  ...
  updateItems() {
    ...
    for (var x of values) {
      ...
      this.addOption(
        ...
        (_a2 = tryGetText("Enums." + enumKey + "." + name)) != null ? _a2 : name,
        null,
        false
      );
    }
  ...
  allowClear() {
    var _a2;
    return (_a2 = this.options.allowClear) != null ? _a2 : true;
  }
};
EnumEditor = __decorateClass([
  Decorators.registerEditor("Serenity.EnumEditor")
], EnumEditor);

// src/ui/editors/lookupeditor.ts
var LookupEditorBase = class extends ComboboxEditor {
  constructor(props) {
    super(props);
    if (!this.hasAsyncSource()) {
      this.updateItems();
...
LookupEditorBase = __decorateClass([
  Decorators.registerEditor("Serenity.LookupEditorBase")
], LookupEditorBase);
var LookupEditor = class extends LookupEditorBase {
  constructor(props) {
    super(props);
  }
};
LookupEditor = __decorateClass([
  Decorators.registerEditor("Serenity.LookupEditor")
], LookupEditor);

// src/ui/editors/servicelookupeditor.ts
var ServiceLookupEditorBase = class extends ComboboxEditor {
  getDialogTypeKey() {
    var dialogTypeKey = super.getDialogTypeKey();
    if (dialogTypeKey)
      return dialogTypeKey;
...
ServiceLookupEditorBase = __decorateClass([
  Decorators.registerEditor("Serenity.ServiceLookupEditorBase")
], ServiceLookupEditorBase);
var ServiceLookupEditor = class extends ServiceLookupEditorBase {
  constructor(props) {
    super(props);
  }
};
ServiceLookupEditor = __decorateClass([
  Decorators.registerEditor("Serenity.ServiceLookupEditor")
], ServiceLookupEditor);

// src/ui/editors/htmlcontenteditor.ts
var HtmlContentEditor = class extends EditorWidget {
  static createDefaultElement() {
    return document.createElement("textarea");
  }
  constructor(props) {
  ...
  instanceReady(x) {
    ...
    this.domNode.classList.forEach((clss) => {
      var _a2;
      (_a2 = x.editor.container.$) == null ? void 0 : _a2.classList.add(clss);
    });
  ...
  getLanguage() {
    ...
    var lang = ((_a2 = document.documentElement.getAttribute("lang")) == null ? void 0 : _a2.trim()) || "en";
  ...
  getEditorInstance() {
    ...
    return (_b = (_a2 = window["CKEDITOR"]) == null ? void 0 : _a2.instances) == null ? void 0 : _b[id];
  }
  destroy() {
  ...
  static includeCKEditor(then) {
    ...
    Fluent("script").attr("type", "text/javascript").attr("id", "CKEditorScript").on("load", then).attr("async", "false").attr("src", resolveUrl(HtmlContentEditor.getCKEditorBasePath() + "ckeditor.js?v=" + HtmlContentEditor.CKEditorVer)).appendTo(document.head);
  }
};
HtmlContentEditor.CKEditorVer = "4.22.1";
HtmlContentEditor = __decorateClass([
  Decorators.registerEditor("Serenity.HtmlContentEditor", [IStringValue, IReadOnly])
], HtmlContentEditor);
var HtmlNoteContentEditor = class extends HtmlContentEditor {
  getConfig() {
...
HtmlNoteContentEditor = __decorateClass([
  Decorators.registerEditor("Serenity.HtmlNoteContentEditor")
], HtmlNoteContentEditor);
var HtmlReportContentEditor = class extends HtmlContentEditor {
  getConfig() {
    var config = super.getConfig();
    config.removeButtons += ",Cut,Copy,Paste,BulletedList,NumberedList,Indent,Outdent,SpecialChar,Subscript,Superscript,Styles,PasteText,PasteFromWord,Strike,Link,Unlink,CreatePlaceholder,Image,Table,HorizontalRule,Source,Maximize,Format,Font,FontSize,Anchor,Blockquote,CreatePlaceholder,BGColor,JustifyLeft,JustifyCenter,JustifyRight,JustifyBlock,Superscript,RemoveFormat";
    config.removePlugins = "elementspath,uploadimage,image2";
...
var MaskedEditor = class extends EditorWidget {
  ...
  constructor(props) {
    ...
    super(props);
    let $2 = getjQuery();
    if ((_a2 = $2 == null ? void 0 : $2.fn) == null ? void 0 : _a2.mask) {
...
var Recaptcha = class extends EditorWidget {
  constructor(props) {
    ...
    if (!!(window["grecaptcha"] == null && !document.querySelector("script#RecaptchaInclude"))) {
      ...
      if (lng == null) {
        lng = (_a2 = document.documentElement.getAttribute("lang")) != null ? _a2 : "";
      }
      src += "?hl=" + lng;
      var script = document.createElement("script");
...
((UploadHelper2) => {
  function addUploadInput(options) {
    ...
    var button = (_b = (_a2 = container.closest(".tool-button")) != null ? _a2 : container.closest("button")) != null ? _b : container;
    ...
    new Uploader({
      ...
      batchSuccess: (data) => {
        var _a3, _b2, _c, _d;
        return (_d = options.fileDone) == null ? void 0 : _d.call(options, (_a3 = data.response) != null ? _a3 : {}, (_c = (_b2 = data.batch) == null ? void 0 : _b2.filePaths) == null ? void 0 : _c[0], data);
      },
  ...
  function colorBox(link, options) {
    ...
    if (!$2)
      return;
    (_b = (_a2 = $2(link)).colorbox) == null ? void 0 : _b.call(_a2, {
  ...
  function populateFileSymbols(c, items, displayOriginalName, urlPrefix) {
    ...
    for (var index = 0; index < items.length; index++) {
      ...
      var originalName = (_a2 = item.OriginalName) != null ? _a2 : "";
...
var FileUploadEditor = class extends EditorWidget {
  constructor(props) {
    super(props);
  ...
  populate() {
    ...
    this.hiddenInput.val(((_a2 = (this.get_value() || {}).Filename) == null ? void 0 : _a2.trim()) || null);
  }
  updateInterface() {
  ...
  set_readOnly(value) {
    ...
    if (this.get_readOnly() !== value) {
      ...
      if (value) {
        ...
        try {
          $2 && ((_b = (_a2 = $2(this.uploadInput)).fileupload) == null ? void 0 : _b.call(_a2, "disable"));
        } catch (e) {
        }
      } else {
  ...
  set_value(value) {
    ...
    if (typeof value === "string") {
      ...
      if (stringValue) {
        ...
        value = null;
    } else if (!((_a2 = value == null ? void 0 : value.Filename) == null ? void 0 : _a2.trim()))
      value = null;
    if (value != null) {
  ...
  getEditValue(property, target) {
    var _a2, _b;
    target[property.name] = ((_b = (_a2 = this.entity) == null ? void 0 : _a2.Filename) == null ? void 0 : _b.trim()) || null;
  }
  setEditValue(source, property) {
    var _a2;
    var value = {};
    ...
    if (!this.options.originalNameProperty) {
      if (this.options.displayFileName) {
        var s = (_a2 = value.Filename) != null ? _a2 : "";
...
ImageUploadEditor = __decorateClass([
  Decorators.registerEditor("Serenity.ImageUploadEditor")
], ImageUploadEditor);
var MultipleFileUploadEditor = class extends EditorWidget {
  constructor(props) {
    super(props);
    this.entities = [];
  ...
  populate() {
    ...
    this.hiddenInput.val(((_a2 = this.get_value()[0]) == null ? void 0 : _a2.Filename) || null);
  }
  updateInterface() {
    var addButton = this.toolbar.findButton("add-file-button");
    addButton.toggleClass("disabled", this.get_readOnly());
...
MultipleFileUploadEditor = __decorateClass([
...
var MultipleImageUploadEditor = class extends MultipleFileUploadEditor {
  constructor(props) {
    super(props);
    this.domNode.classList.add("s-MultipleImageUploadEditor'");
  }
};
MultipleImageUploadEditor = __decorateClass([
...
var QuickFilterBar = class extends Widget {
  constructor(props) {
    var _a2;
    super(props);
    ...
    this.options.idPrefix = (_a2 = this.options.idPrefix) != null ? _a2 : this.uniqueName + "_";
  }
  addSeparator() {
  ...
  add(opt) {
    ...
    var title = (_a2 = tryGetText(opt.title)) != null ? _a2 : opt.title;
    if (title == null) {
  ...
  addDateRange(field, title) {
    return this.add(QuickFilterBar.dateRange(field, title));
  }
  static dateRange(field, title) {
    ...
    return {
      ...
      displayText: function(w, l) {
        ...
        var text2 = l + " <= " + v2;
        if (v1 && v2) {
          return text1 + " " + ((_a2 = tryGetText("Controls.FilterPanel.And")) != null ? _a2 : "and") + " " + text2;
        } else if (v1) {
          return text1;
        } else {
          return text2;
  ...
  addDateTimeRange(field, title) {
    return this.add(QuickFilterBar.dateTimeRange(field, title));
  }
  static dateTimeRange(field, title, useUtc) {
    ...
    return {
      ...
      init: function(w) {
        var _a2;
        Fluent.on((_a2 = w.domNode.parentElement) == null ? void 0 : _a2.querySelector(".time"), "change", () => Fluent.trigger(w.domNode, "change"));
      },
      handler: function(args) {
        var date1 = parseDate(args.widget.value);
        if (date1) {
  ...
  static boolean(field, title, yes, no) {
    ...
    return {
      ...
      handler: function(args) {
        var _a2;
        args.equalityFilter[args.field] = !((_a2 = args.value) == null ? void 0 : _a2.toString()) ? null : !!toId(args.value);
      }
    };
  }
  destroy() {
  ...
  find(type, field) {
    ...
    return getWidgetFrom((_b = (_a2 = this.domNode) == null ? void 0 : _a2.querySelector(selector)) != null ? _b : selector, type);
  }
  tryFind(type, field) {
    var _a2, _b;
    const selector = "#" + this.options.idPrefix + field;
    return tryGetWidget((_b = (_a2 = this.domNode) == null ? void 0 : _a2.querySelector(selector)) != null ? _b : selector, type);
  }
};
QuickFilterBar = __decorateClass([
  Decorators.registerClass("Serenity.QuickFilterBar")
], QuickFilterBar);

// src/ui/datagrid/quicksearchinput.ts
var QuickSearchInput = class extends Widget {
  static createDefaultElement() {
    return Fluent("input").attr("type", "text").getNode();
  }
  constructor(props) {
    ...
    this.lastValue = ((_a2 = this.domNode.value) != null ? _a2 : "").trim();
    ...
    if (((_b = this.options.fields) == null ? void 0 : _b.length) > 0) {
      ...
      this.options.fields.forEach((item) => {
        var _a3;
        return Fluent("li").appendTo(menu).append(Fluent("a").class("dropdown-item").attr("href", "#").text((_a3 = item.title) != null ? _a3 : "").on("click", (e) => {
          e.preventDefault();
    ...
    Fluent.on(this.domNode, "execute-search." + this.uniqueName, () => {
      ...
      this.searchNow(((_a3 = this.domNode.value) != null ? _a3 : "").trim());
    });
  }
  checkIfValueChanged() {
    var _a2;
    ...
    }, (_a2 = this.options.typeDelay) != null ? _a2 : 500);
    this.lastValue = value;
  }
  get_value() {
    var _a2;
    return ((_a2 = this.domNode.value) != null ? _a2 : "").trim();
  }
  get_field() {
    return this.field;
  }
  ...
  updateInputPlaceHolder() {
    var _a2, _b;
    this.fieldLink && (this.fieldLink.textContent = (_b = (_a2 = this.field) == null ? void 0 : _a2.title) != null ? _b : "");
  }
  ...
  searchNow(value) {
    ...
    (_b = this.domNode.parentElement) == null ? void 0 : _b.classList.toggle(
      (_a2 = this.options.filteredParentClass) != null ? _a2 : "s-QuickSearchFiltered",
      !!(value.length > 0)
    );
    ...
    var done = (results) => {
      ...
      (_a3 = this.domNode.parentElement) == null ? void 0 : _a3.classList.remove(klass);
      if (!results) {
...
QuickSearchInput = __decorateClass([
...
var BaseFiltering = class {
  ...
  operatorFormat(op) {
    var _a2, _b;
    return (_b = (_a2 = op.format) != null ? _a2 : tryGetText("Controls.FilterPanel.OperatorFormats." + op.key)) != null ? _b : op.key;
  }
  getTitle(field) {
    var _a2, _b;
    return (_b = tryGetText(field.title)) != null ? _b : (_a2 = field.title) != null ? _a2 : field.name;
  }
  ...
  getEditorValue() {
    ...
    if (inputs.length !== 1) {
      throw new Exception(stringFormat(
        ...
        (_a2 = this.field.title) != null ? _a2 : this.field.name
      ));
    }
    let input = inputs[0];
    var value;
  ...
  getEditorText() {
    ...
    if (!input) {
      return (_a2 = this.get_container().textContent) == null ? void 0 : _a2.trim();
    }
    var value;
    let combobox = Combobox.getInstance(input);
    if (combobox) {
...
var BaseEditorFiltering = class extends BaseFiltering {
...
BaseEditorFiltering = __decorateClass([
  Filtering("BaseEditor")
], BaseEditorFiltering);
var DateFiltering = class extends BaseEditorFiltering {
  constructor() {
    super(DateEditor);
  }
  getOperators() {
...
DateFiltering = __decorateClass([
  Filtering("Date")
], DateFiltering);
var BooleanFiltering = class extends BaseFiltering {
  getOperators() {
...
BooleanFiltering = __decorateClass([
  Filtering("Boolean")
], BooleanFiltering);
var DateTimeFiltering = class extends BaseEditorFiltering {
  constructor() {
...
DateTimeFiltering = __decorateClass([
  Filtering("DateTime")
], DateTimeFiltering);
var DecimalFiltering = class extends BaseEditorFiltering {
  constructor() {
    super(DecimalEditor);
  }
  getOperators() {
...
DecimalFiltering = __decorateClass([
  Filtering("Decimal")
], DecimalFiltering);
var EditorFiltering = class extends BaseEditorFiltering {
  constructor(props = {}) {
    var _a2;
    super(Widget);
    this.props = props;
    (_a2 = this.props) != null ? _a2 : this.props = {};
  }
  get editorType() {
  ...
  getEditorOptions() {
    ...
    if (this.useEditor() && this.editorType === ((_a2 = this.get_field().editorType) != null ? _a2 : "String")) {
...
EditorFiltering = __decorateClass([
  Filtering("Editor")
], EditorFiltering);
var EnumFiltering = class extends BaseEditorFiltering {
  constructor() {
    super(EnumEditor);
  }
  getOperators() {
...
EnumFiltering = __decorateClass([
  Filtering("Enum")
], EnumFiltering);
var IntegerFiltering = class extends BaseEditorFiltering {
  constructor() {
    super(IntegerEditor);
  }
  getOperators() {
...
IntegerFiltering = __decorateClass([
  Filtering("Integer")
], IntegerFiltering);
var LookupFiltering = class extends BaseEditorFiltering {
  constructor() {
    super(LookupEditor);
  }
  getOperators() {
...
LookupFiltering = __decorateClass([
  Filtering("Lookup")
], LookupFiltering);
var ServiceLookupFiltering = class extends BaseEditorFiltering {
  constructor() {
...
ServiceLookupFiltering = __decorateClass([
  Filtering("ServiceLookup")
], ServiceLookupFiltering);
var StringFiltering = class extends BaseFiltering {
  getOperators() {
    var ops = [
...
StringFiltering = __decorateClass([
  Filtering("String")
], StringFiltering);
...
var FilterWidgetBase = class extends Widget {
  constructor(props) {
    super(props);
...
FilterWidgetBase = __decorateClass([
  Decorators.registerClass("Serenity.FilterWidgetBase")
], FilterWidgetBase);

// src/ui/filtering/filterpanel.ts
var FilterFieldSelect = class extends ComboboxEditor {
  constructor(props) {
    var _a2, _b;
    super(props);
    for (var field of this.options.fields) {
      this.addOption(field.name, (_b = (_a2 = tryGetText(field.title)) != null ? _a2 : field.title) != null ? _b : field.name, field);
    }
  }
  emptyItemText() {
    if (!this.value) {
...
FilterFieldSelect = __decorateClass([
  Decorators.registerClass("Serenity.FilterFieldSelect")
], FilterFieldSelect);
var FilterOperatorSelect = class extends ComboboxEditor {
  constructor(props) {
    var _a2, _b;
    super(props);
    for (var op of this.options.source) {
      var title = (_b = op.title) != null ? _b : (_a2 = tryGetText("Controls.FilterPanel.OperatorNames." + op.key)) != null ? _a2 : op.key;
...
FilterOperatorSelect = __decorateClass([
  Decorators.registerClass("Serenity.FilterOperatorSelect")
], FilterOperatorSelect);
var FilterPanel = class extends FilterWidgetBase {
  constructor(props) {
    super(props);
  ...
  search() {
    ...
    for (var i = 0; i < this.rowsDiv.children.length; i++) {
      ...
      try {
        ...
        errorText = (_a2 = ex.message) != null ? _a2 : ex.toString();
        break;
      }
  ...
  addEmptyRow(popupField) {
    ...
    if (emptyRow != null) {
      (_a2 = emptyRow.querySelector("input.field-select")) == null ? void 0 : _a2.focus();
      if (popupField) {
  ...
  onRowFieldChange(e) {
    ...
    (_a2 = row.querySelector("div.o input.op-select")) == null ? void 0 : _a2.focus();
  }
  rowFieldChange(row) {
  ...
  getFilteringFor(row) {
    ...
    var filteringType = FilteringTypeRegistry.get(
      (_a2 = field.filteringType) != null ? _a2 : "String"
    );
...
var FilterDisplayBar = class extends FilterWidgetBase {
  ...
  filterStoreChanged() {
    var _a2;
    super.filterStoreChanged();
    var displayText = ((_a2 = this.get_store().get_displayText()) == null ? void 0 : _a2.trim()) || null;
...
FilterDisplayBar = __decorateClass([
  Decorators.registerClass("Serenity.FilterDisplayBar")
], FilterDisplayBar);

// src/ui/datagrid/slickpager.ts
var SlickPager = class extends Widget {
  constructor(props) {
    var _a2, _b;
    super(props);
    let opt = this.options;
    (_a2 = opt.showRowsPerPage) != null ? _a2 : opt.showRowsPerPage = true;
  ...
  _updatePager() {
    ...
    this.stat.text(stat);
    (_a2 = this.pageSize) == null ? void 0 : _a2.val((info.rowsPerPage || 0).toString());
  }
};
SlickPager = __decorateClass([
...
from the project folder.`;
  ...
  FormatterTypeRegistry2.get = get;
  function reset() {
    registry.reset();
  }
  FormatterTypeRegistry2.reset = reset;
  function tryGet(key) {
    return registry.tryGet(key);
  }
  FormatterTypeRegistry2.tryGet = tryGet;
})(FormatterTypeRegistry || (FormatterTypeRegistry = {}));

// src/ui/formatters/formatters.ts
var IInitializeColumn = class {
};
IInitializeColumn = __decorateClass([
...
var BooleanFormatter = class {
  ...
  format(ctx) {
    ...
    if (ctx.value == null)
      return "";
    if (!!ctx.value)
      return ctx.escape(localText(this.trueText, (_a2 = this.trueText) != null ? _a2 : DialogTexts.YesButton));
...
CheckboxFormatter = __decorateClass([
  Decorators.registerType()
], CheckboxFormatter);
...
var EnumFormatter = class {
  ...
  static getText(enumKey, name) {
    ...
    if (!name)
      return "";
    return htmlEncode((_a2 = tryGetText("Enums." + enumKey + "." + name)) != null ? _a2 : name);
  }
...
EnumFormatter = __decorateClass([
  Decorators.registerFormatter("Serenity.EnumFormatter")
], EnumFormatter);
var FileDownloadFormatter = class {
  constructor(props = {}) {
    this.props = props;
    var _a2;
    (_a2 = this.props) != null ? _a2 : this.props = {};
  ...
  format(ctx) {
    ...
    var text2 = stringFormat(
      (_a2 = this.displayFormat) != null ? _a2 : "{0}",
      originalName,
      dbFile,
      downloadUrl
    );
...
MinuteFormatter = __decorateClass([
...
var NumberFormatter = class {
  ...
  static format(value, format2) {
    ...
    if (dbl == null || isNaN(dbl))
      return (_a2 = value == null ? void 0 : value.toString()) != null ? _a2 : "";
...
var UrlFormatter = class {
  ...
  format(ctx) {
    var _a2, _b, _c, _d;
    var url = this.urlProperty ? ((_a2 = ctx.item[this.urlProperty]) != null ? _a2 : "").toString() : ((_b = ctx.value) != null ? _b : "").toString();
    if (!url)
      return "";
    if (this.urlFormat)
...
GridRowSelectionMixin = __decorateClass([
...
GridRadioSelectionMixin = __decorateClass([
...
((GridSelectAllButtonHelper2) => {
  ...
  function define(getGrid, getId, getSelected, setSelected, text2, onClick) {
    var _a2;
    if (text2 == null) {
      text2 = (_a2 = tryGetText("Controls.CheckTreeEditor.SelectAll")) != null ? _a2 : "Select All";
    }
    return {
      title: text2,
      action: "select-all",
  ...
  function addQuickSearchInput(toolDiv, view, fields, onChange) {
    ...
    view.onSubmit = function(v) {
      ...
      if (input) {
        ...
        var searchField = (_a2 = input.get_field()) == null ? void 0 : _a2.name;
  ...
  function makeOrderableWithUpdateRequest(grid, getId, getDisplayOrder, service, getUpdateRequest) {
    makeOrderable(grid.getGrid(), function(rows, insertBefore) {
      ...
      if (index < 0) {
        ...
        order = (_a2 = getDisplayOrder(grid.getGrid().getDataItem(grid.getGrid().getDataLength() - 1))) != null ? _a2 : 0;
        if (order === 0) {
...
((PropertyItemSlickConverter2) => {
  ...
  function toSlickColumn(item) {
    ...
    var result = {
      ...
      sortOrder: (_a2 = item.sortOrder) != null ? _a2 : 0,
    ...
    if (item.formatterType != null && item.formatterType.length > 0) {
      ...
      var formatter = new formatterType((_c = item.formatterParams) != null ? _c : {});
...
((SlickFormatting2) => {
  ...
  function treeToggle(getView, getId, formatter) {
    return function(ctx) {
      ...
      var view = getView();
      var indent = (_a2 = ctx.item._indent) != null ? _a2 : 0;
  ...
  function getItemType(link) {
    var _a2;
    return (_a2 = isArrayLike(link) ? link[0] : link) == null ? void 0 : _a2.getAttribute("data-item-type");
  }
  SlickFormatting2.getItemType = getItemType;
  function getItemId(link) {
    var _a2;
    var value = (_a2 = isArrayLike(link) ? link[0] : link) == null ? void 0 : _a2.getAttribute("data-item-id");
  ...
  function itemLink(itemType, idField, getText, cssClass, encode) {
    return function(ctx) {
      var _a2, _b;
      var text2 = (_a2 = getText == null ? ctx.value : getText(ctx)) != null ? _a2 : "";
...
var ColumnsBase = class {
  constructor(items) {
    ...
    for (var col of items) {
      let id = (_a2 = col.sourceItem) == null ? void 0 : _a2.name;
      if (id && !this[id])
        this[id] = col;
    }
    for (var col of items) {
...
var DataGrid = class extends Widget {
  constructor(props) {
    super(props);
  ...
  propertyItemsReady(itemsData) {
    var _a2;
    this.propertyItemsData = itemsData;
    this.allColumns = (_a2 = this.allColumns) != null ? _a2 : this.getColumns();
  ...
  getQuickFilters() {
    ...
    }).map((x) => DataGrid.propertyItemToQuickFilter(x.sourceItem)).filter((x) => x != null);
  }
  static propertyItemToQuickFilter(item) {
    ...
    var filteringType = FilteringTypeRegistry.get((_a2 = item.filteringType) != null ? _a2 : "String");
  ...
  createQuickSearchInput() {
    ...
    (_a2 = input == null ? void 0 : input.domNode) == null ? void 0 : _a2.setAttribute("id", this.idPrefix + "QuickSearchInput");
  }
  destroy() {
  ...
  getColumnWidthDelta() {
    var _a2;
    return (_a2 = DataGrid.defaultColumnWidthDelta) != null ? _a2 : 0;
  }
  getColumnWidthScale() {
    var _a2;
    return (_a2 = DataGrid.defaultColumnWidthScale) != null ? _a2 : 1;
  }
  initialPopulate() {
    var self2 = this;
  ...
  getAddButtonCaption() {
    var _a2;
    return (_a2 = tryGetText("Controls.DataGrid.NewButton")) != null ? _a2 : "New";
  }
  getButtons() {
    return [];
  }
  ...
  enableFiltering() {
    var _a2;
    return (_a2 = this.getCustomAttribute(FilterableAttribute)) == null ? void 0 : _a2.value;
  }
  populateWhenVisible() {
    return false;
  }
  ...
  getColumnsKey() {
    var _a2;
    return (_a2 = this.getCustomAttribute(ColumnsKeyAttribute)) == null ? void 0 : _a2.value;
  }
  getPropertyItems() {
    var _a2;
    return ((_a2 = this.propertyItemsData) == null ? void 0 : _a2.items) || [];
  ...
  getPropertyItemsData() {
    ...
    if (this.getColumnsKey === DataGrid.prototype.getColumnsKey && this.getPropertyItems !== DataGrid.prototype.getPropertyItems && !ScriptData.canLoad("Columns." + columnsKey)) {
      return {
        items: this.getPropertyItems(),
        additionalItems: []
      };
  ...
  getLocalTextDbPrefix() {
    ...
    this._localTextDbPrefix = (_a2 = this.getLocalTextPrefix()) != null ? _a2 : "";
  ...
  getLocalTextPrefix() {
    ...
    return (_a2 = this.getCustomAttribute(LocalTextPrefixAttribute)) == null ? void 0 : _a2.value;
  }
  getIdProperty() {
    var _a2, _b;
    ...
    var rowDefinition = this.getRowDefinition();
    if (rowDefinition)
      return this._idProperty = (_a2 = rowDefinition.idProperty) != null ? _a2 : "";
  ...
  getIsDeletedProperty() {
    var _a2;
    return (_a2 = this.getRowDefinition()) == null ? void 0 : _a2.isDeletedProperty;
  }
  getIsActiveProperty() {
    var _a2, _b;
    ...
    var rowDefinition = this.getRowDefinition();
    if (rowDefinition)
      return this._isActiveProperty = (_a2 = rowDefinition.isActiveProperty) != null ? _a2 : "";
  ...
  resizeCanvas() {
    var _a2;
    (_a2 = this.slickGrid) == null ? void 0 : _a2.resizeCanvas();
  }
  subDialogDataChange() {
    this.refresh();
  }
  ...
  restoreSettingsFrom(settings, flags) {
    ...
    try {
      ...
      if (settings.columns != null) {
        ...
        if (flags.sortColumns !== false) {
          ...
          var sortColumns = settings.columns.filter(function(x3) {
            var _a3;
            return x3.id != null && ((_a3 = x3.sort) != null ? _a3 : 0) !== 0;
          });
      ...
      if (flags.quickSearch === true && (settings.quickSearchField !== void 0 || settings.quickSearchText !== void 0)) {
        var qsInput = (_b = (_a2 = this.toolbar) == null ? void 0 : _a2.domNode) == null ? void 0 : _b.querySelector(".s-QuickSearchInput");
        if (qsInput) {
    ...
    if (flags.quickFilters !== false && this.quickFiltersDiv != null && this.quickFiltersDiv.length > 0) {
      ...
      this.quickFiltersDiv.findAll(".quick-filter-item").forEach((e) => {
        ...
        if (flags.quickFilterText === true && e.classList.contains("quick-filter-active")) {
          ...
          var filterLabel = (_b2 = (_a3 = e.querySelector(".quick-filter-label")) == null ? void 0 : _a3.textContent) != null ? _b2 : "";
          var displayText;
...
var ColumnPickerDialog = class extends BaseDialog {
  renderContents() {
  ...
  onDialogOpen() {
    ...
    this.setupColumns();
    super.onDialogOpen();
    var restoreButton = (_b = (_a2 = Dialog.getInstance(this.domNode)) == null ? void 0 : _a2.getFooterNode()) == null ? void 0 : _b.querySelector(".restore-defaults");
    if (restoreButton)
      (_d = (_c = restoreButton.nextElementSibling) == null ? void 0 : _c.focus) == null ? void 0 : _d.call(_c);
  }
};
ColumnPickerDialog = __decorateClass([
...
var TreeGridMixin = class _TreeGridMixin {
  constructor(options) {
    ...
    if (options.toggleField) {
      var col = (_a2 = dg["allColumns"] || dg.slickGrid.getColumns()) == null ? void 0 : _a2.find((x) => x.field == options.toggleField);
      if (col) {
...
var CheckTreeEditor = class extends DataGrid {
  static createDefaultElement() {
    return document.createElement("div");
  }
  constructor(props) {
  ...
  getSelectAllText() {
    var _a2;
    return (_a2 = tryGetText("Controls.CheckTreeEditor.SelectAll")) != null ? _a2 : "Select All";
  }
...
var CheckLookupEditor = class extends CheckTreeEditor {
  ...
  getButtons() {
    var _a2;
    return (_a2 = super.getButtons()) != null ? _a2 : this.options.hideSearch ? null : [];
  }
  createToolbarExtensions() {
  ...
  getTreeItems() {
    ...
    return items.map((item) => {
      var _a2, _b;
      return {
        id: ((_a2 = item[lookup.idField]) != null ? _a2 : "").toString(),
...
var EntityGrid = class extends DataGrid {
  ...
  editItemOfType(itemType, entityOrId) {
    ...
    this.createEntityDialog(itemType, (dlg) => {
      var dialog = safeCast(dlg, IEditDialog);
      if (dialog != null) {
        dialog.load(entityOrId, () => dialog.dialogOpen(this.openDialogsAsPanel));
        return;
      }
      throw new Error(
        stringFormat(
  ...
  getInsertPermission() {
    var _a2;
    return (_a2 = this.getRowDefinition()) == null ? void 0 : _a2.insertPermission;
  }
  hasInsertPermission() {
...
var EntityDialog = class extends BaseDialog {
  ...
  getEntityNameFieldValue() {
    var _a2;
    return ((_a2 = this.entity[this.getNameProperty()]) != null ? _a2 : "").toString();
  }
  getEntityTitle() {
    var _a2;
    if (!this.isEditMode()) {
      ...
      var title = (_a2 = this.getEntityNameFieldValue()) != null ? _a2 : "";
      return stringFormat(
        titleFormat,
  ...
  getEntitySingular() {
    ...
    var attr2 = this.getCustomAttribute(ItemNameAttribute);
    return this._entitySingular = attr2 ? localText(attr2.value, attr2.value) : (_a2 = tryGetText(this.getLocalTextDbPrefix() + "EntitySingular")) != null ? _a2 : this.getEntityType();
  }
  getNameProperty() {
    var _a2, _b;
    ...
    var rowDefinition = this.getRowDefinition();
    if (rowDefinition)
      return this._nameProperty = (_a2 = rowDefinition.nameProperty) != null ? _a2 : "";
  ...
  getPropertyItemsData() {
    var formKey = this.getFormKey();
    if (this.getFormKey === EntityDialog.prototype.getFormKey && this.getPropertyItems !== EntityDialog.prototype.getPropertyItems && !ScriptData.canLoad("Form." + formKey)) {
      return {
        items: this.getPropertyItems(),
        additionalItems: []
      };
  ...
  getUpdatePermission() {
    var _a2;
    return (_a2 = this.getRowDefinition()) == null ? void 0 : _a2.updatePermission;
  }
  getDeletePermission() {
    var _a2;
    return (_a2 = this.getRowDefinition()) == null ? void 0 : _a2.deletePermission;
  }
  hasDeletePermission() {
